<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="labelsUrl">
		<xsl:choose>
			<xsl:when test="doc-available(concat($xmlPath, 'fgases-labels-verification-', $labelsLanguage ,'.xml'))">
				<xsl:value-of select="concat($xmlPath, 'fgases-labels-verification-', $labelsLanguage ,'.xml')"/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="concat($xmlPath, 'fgases-labels-verification-en.xml')"/>
			</xsl:otherwise>
		</xsl:choose>
	</xsl:variable>
		...
		<table id="table-1" class="table table-hover table-bordered">
			<tbody>
				<tr>
					...
					<td >
						<xsl:call-template name="getValue"><xsl:with-param name="elem" select="Auditor/CompanyName"/></xsl:call-template>
					</td>
					<th>
						<xsl:call-template name="getLabel">
				...
				<tr>
					...
					<td >
						<xsl:call-template name="getValue"><xsl:with-param name="elem" select="Auditor/Address/PostalCode"/></xsl:call-template>
					</td>
					<th>
						<xsl:call-template name="getLabel">
		...
		<table id="table-1" class="table table-hover table-bordered">
			<tbody>
				<tr>					
					...
					<td >
						<xsl:call-template name="getValue"><xsl:with-param name="elem" select="Auditor/Name"/></xsl:call-template>
					</td>
					<th>
						<xsl:call-template name="getLabel">
...
<!-- Cleans up leftovers -->
	...
	<xsl:template match="ReportedBulk">
		...
		<table id="table-reportedBulk" class="table table-hover table-bordered">
			<thead>
			<tr>
				<th colspan="6">
					<xsl:call-template name="getLabel">
			...
			<tbody>
				...
				<tr>					
					<xsl:for-each select="ReportedGases">	
						...
						<td style="text-align: center; padding: 0px; " class="ng-scope">
		...
		<table class="table table-hover table-bordered fixed-table bulk-hfcs-amounts ng-scope" style="font-size: 90%;">
    <thead>
        <tr>
            <th>
    ...
    <tbody>
    	<tr id="bulk-hfcs-verification-confirmation-tr_01A" ng-repeat="transaction in instance.Verification.ReportedBulk.Transactions" class="ng-scope">    		
    		...
    		<td  class="confirmation no-bottom-border">
    			...
    			<xsl:if test="../BulkHFCs/section_I_2/tr_01A/confirmation_b/option_4 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-b4'"/>
    				</xsl:call-template></span><br></br><span><xsl:call-template name="getValue"><xsl:with-param name="elem" select="../BulkHFCs/section_I_1/confirmation_b/option_4_reason"/></xsl:call-template></span>
    			</xsl:if>    			
    		</td>
    		<td  class="confirmation no-bottom-border">
    			<input class="form-check-input ng-pristine ng-untouched ng-valid ng-scope" type="checkbox" >
    			...
    			<xsl:if test="../BulkHFCs/section_I_2/tr_01A/confirmation_c/option_4 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-c4'"/>
    				</xsl:call-template></span><br></br><span><xsl:call-template name="getValue"><xsl:with-param name="elem" select="../BulkHFCs/section_I_1/confirmation_c/option_4_reason"/></xsl:call-template></span>
    			</xsl:if>    			
    		</td>    		
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_01A_a_own" class="ng-scope">    		
    		...
    		<td class="transaction">
    			...
    			<div class="ng-scope">
    				<br></br>
    					<span class="formula ng-binding">Calculated: [11_R = 13Bb = 11_G]</span>
    			</div>
    		</td>
    		<td class="tco2e">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_01A_a_other" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">01A_a_other</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_01B" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">01B</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_01C" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">01C</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_02A" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">02A</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_02B" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">02B</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_02G" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">02G</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_02H" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">02H</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_02I" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">02I</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_03B" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">03B</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_04C" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">04C</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_04H" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">04H</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_04M" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">04M</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_05A" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">05A</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_05B" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">05B</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_05C_exempted" class="ng-scope">    		
    		<td class="confirmation">
    			<input class="" type="checkbox" >
    				<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_a/checked = 'true'">
    					<xsl:attribute name="checked">checked</xsl:attribute>
    				</xsl:if>
    			</input>
    		</td>
    		<td  class="confirmation">
    			<input class="form-check-input ng-pristine ng-untouched ng-valid ng-scope" type="checkbox" >
    				<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_b/checked = 'true'">
    					<xsl:attribute name="checked">checked</xsl:attribute>								
    				</xsl:if>
    			</input>
    			<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_b/option_1 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-b1'"/>
    				</xsl:call-template></span>
    			</xsl:if>
    			<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_b/option_2 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-b2'"/>
    				</xsl:call-template></span>
    			</xsl:if>
    			<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_b/option_3 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-b3'"/>
    				</xsl:call-template></span>
    			</xsl:if>
    			<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_b/option_4 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-b4'"/>
    				</xsl:call-template></span><br></br><span><xsl:call-template name="getValue"><xsl:with-param name="elem" select="../BulkHFCs/section_I_1/confirmation_b/option_4_reason"/></xsl:call-template></span>
    			</xsl:if>    			
    		...
    		<td  class="confirmation">
    			<input class="" type="checkbox" >
    				<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_c/checked = 'true'">
    					<xsl:attribute name="checked">checked</xsl:attribute>								
    				</xsl:if>
    			</input>
    			<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_c/option_1 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-c1'"/>
    				</xsl:call-template></span>
    			</xsl:if>
    			<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_c/option_2 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-c2'"/>
    				</xsl:call-template></span>
    			</xsl:if>
    			<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_c/option_3 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-c3'"/>
    				</xsl:call-template></span>
    			</xsl:if>
    			<xsl:if test="../BulkHFCs/section_I_2/tr_05C_exempted/confirmation_c/option_4 = 'true'">
    				<span ><xsl:call-template name="getLabel">
    					<xsl:with-param name="labelName" select="'section-I-1-table-option-c4'"/>
    				</xsl:call-template></span><br></br><span><xsl:call-template name="getValue"><xsl:with-param name="elem" select="../BulkHFCs/section_I_1/confirmation_c/option_4_reason"/></xsl:call-template></span>
    			</xsl:if>    			
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">05C_exempted</span>
    		</td>
    		<td class="transaction">
    		...
    		<td class="tco2e">
    			<span><xsl:call-template name="getValue"><xsl:with-param name="elem" select="Transactions[id='tr_05C_exempted']/tco2e"/></xsl:call-template></span>
    		</td>
    		<xsl:for-each select="Transactions[id='tr_05C_exempted']/gases">
    			<td  class="amount ng-scope" data-tooltip="">               
    				<span><xsl:call-template name="getValue"><xsl:with-param name="elem" select="amount"/></xsl:call-template></span>    			
    			</td>
    		</xsl:for-each>
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_05D" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">05D</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_05E" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">05E</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_05F" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">05F</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_05I" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">05I</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_05J" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">05J</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_09A_imp" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">09A_imp</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_09A_add" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">09A_add</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_09A" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">09A</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_09C" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">09C</span>
    		</td>
    		<td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_09F" class="ng-scope">    		
    		...
    		<td class="transaction-code">
    			<span class="ng-binding">09F</span>
    		</td>
    		<td class="transaction">
        ...
        <tr>
        	...
        	<td class="no-top-border" >
                ...
                <span data-translate="bulk-hfcs-verification.table-confirmed-a-description" class="ng-scope">Auditor’s statement, option c: Based on the verification conducted, we cannot provide reasonable assurance that the selection of hydrofluorocarbons is accurate and complete.</span>
            </td>
        </tr>
        <tr>
        	<td class="no-top-border no-bottom-border"></td>
        	<td class="no-top-border">
                ...
                <span data-translate="bulk-hfcs-verification.table-confirmed-b-description" class="ng-scope">Auditor’s statement, option b: We provide reasonable assurance that the selection of hydrofluorocarbons is accurate and complete, though the observations as indicated warrant attention.</span>
            </td>
        </tr>
        <tr>
        	<td class="no-top-border">
                ...
                <span data-translate="bulk-hfcs-verification.table-confirmed-c-description" class="ng-scope">Auditor’s statement, option a: We confirm with reasonable assurance that the selection of hydrofluorocarbons is accurate and complete.</span>
            </td>
        </tr>
    </tbody>
</table>
		...
		<div class="hfcs-verification-section ng-scope" ng-include="" src="'section_I_4.html'"><div class="ng-scope">
			...
			<div class="ng-scope">
				...
				<a id="bulk-hfcs-verification-verification-report"  target="_blank" class="ng-binding">
					<xsl:attribute name="href">
						<xsl:value-of select="../BulkHFCs/section_I_4/VerificationReport/Url"/>
					</xsl:attribute>
	...
	<xsl:template match="ReportedEquipment">
		...
		<table id="table-reportedEquipment" class="table table-hover table-bordered">
			<thead>
			<tr>
				<th colspan="6">
					<xsl:call-template name="getLabel">
    ...
    <tbody>
    	<tr id="bulk-hfcs-verification-confirmation-tr_011G" class="ng-scope">    		
            ...
            <td class="transaction-code">
                <span class="ng-binding">11G</span>
            </td>
            <td class="transaction">
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_11R" class="ng-scope">    		
    		<td class="confirmation">
    			<input class="form-check-input ng-pristine ng-untouched ng-valid ng-scope" type="checkbox" >
    		...
    		<td  class="confirmation">
    			<input class="form-check-input ng-pristine ng-untouched ng-valid ng-scope" type="checkbox" >
    				<xsl:if test="../EquipmentHFCs/ssection_II_2/tr_12A/confirmation_c/checked = 'true'">
    					<xsl:attribute name="checked">checked</xsl:attribute>								
    				</xsl:if>
    			</input>
    	...
    	<tr id="bulk-hfcs-verification-confirmation-tr_13D" class="ng-scope">    		
    		...
    		<td class="transaction">
    			...
    			<div class="ng-scope">
    				<br></br>
    				<span class="formula ng-binding">Calculated: [13D = 11_R – 12A –12aA]</span>
    			</div>
    		</td>
    		<td class="tco2e">
        ...
        <tr>
        	...
        	<td  class="no-top-border">
                ...
                <span class="ng-scope">Auditor’s statement, option b: We provide reasonable assurance that the selection of hydrofluorocarbons is accurate and complete, though the observations as indicated warrant attention.</span>
            </td>
        </tr>
        <tr>
        	<td colspan="7" class="no-top-border">
                ...
                <span class="ng-scope">Auditor’s statement, option a: We confirm with reasonable assurance that the selection of hydrofluorocarbons is accurate and complete.</span>
            </td>
        </tr>
    </tbody>
</table>
	...
	<tbody>
		<tr id="bulk-hfcs-verification-confirmation-tr_11P" class="ng-scope">    		
			...
			<td class="transaction">
				<span style="white-space: pre-wrap;" class="ng-binding">Reported category explanation</span>
				...
				<tbody id="equipment-verification-section-II-4-option-a">
					<tr>
						<td id="equipment-verification-section-II-4-option-a-1">
							...
							<br></br>
							<xsl:if test="../EquipmentHFCs/section_II_4/option_a/option = '1'">
								<span data-translate="equipment-verification.section-II-4-part-1-option-1-comment" class="ng-scope">Option A was used in declaration(s) of conformity and sufficient availability of quota authorisations is confirmed by the auditor.
									However, the veracity of data pursuant to Art. 26(7) of Regulation (EU) 2024/573 as reported in section 13D of the report was not confirmed by the auditor (or no HFCs were reported in section 13D)
									Comment by the auditor:</span>
								<br></br>
								<input type="text">
					...
					<tr>
						<td id="equipment-verification-section-II-4-option-a-2">
							...
							<br></br>
							<xsl:if test="../EquipmentHFCs/section_II_4/option_a/option = '2'">
								<span data-translate="equipment-verification.section-II-4-part-1-option-2-comment" class="ng-scope">Option A was used in declaration(s) of conformity and sufficient availability of quota authorisations is not confirmed by the auditor.
									However, pursuant to Art. 26(7) of Regulation (EU) 2024/573 no data were reported in section 13D of the report.
									Comment by the auditor:</span>
								<br></br>
								<input type="text">
									<xsl:attribute name="value">
					...
					<tr>
						...
						<td id="equipment-verification-section-II-4-option-a-3">
							...
							<br></br>
							<xsl:if test="../EquipmentHFCs/section_II_4/option_a/option = '3'">
								<span data-translate="equipment-verification.section-II-4-part-1-option-3-comment" class="ng-scope">Option A was not used in declaration(s) of conformity.
									However, HFCs were reported in section 13D of the report and the veracity of the reported data pursuant to Art. 26(7) of Regulation (EU) 2024/573 was confirmed by the auditor.
									Comment by the auditor:</span>
								<br></br>
								<input type="text">
									<xsl:attribute name="value">
				...
				<tbody id="equipment-verification-section-II-4-option-a">
					<tr>
						<td id="equipment-verification-section-II-4-option-a-1">
							...
							<br></br>
							<xsl:if test="../EquipmentHFCs/section_II_4/option_b/option = '1'">
								<span  class="ng-scope">Option B was used in declaration(s) of conformity and availability of supporting declaration(s) is confirmed by the auditor.
									However, the veracity of data pursuant to Art. 26(7) of Regulation (EU) 2024/573 reported in section 12A of the report was not confirmed by the auditor (or no data were reported in section 12A)
									Comment by the auditor:</span>
								<br></br>
								<input type="text">
									<xsl:attribute name="value">
					...
					<tr>
						<td id="equipment-verification-section-II-4-option-a-2">
							...
							<br></br>
							<xsl:if test="../EquipmentHFCs/section_II_4/option_b/option = '2'">
								<span data-translate="equipment-verification.section-II-4-part-1-option-2-comment" class="ng-scope">Option B was used in declaration(s) of conformity and availability of supporting declaration(s) is not confirmed by the auditor.
									However, pursuant to Art. 26(7) of Regulation (EU) 2024/573 no data were reported in section 12A of the report .
									Comment by the auditor:</span>
								<br></br>
								<input type="text">
									<xsl:attribute name="value">
					...
					<tr>
						...
						<td id="equipment-verification-section-II-4-option-a-3">
							...
							<br></br>
							<xsl:if test="../EquipmentHFCs/section_II_4/option_b/option = '3'">
								<span data-translate="equipment-verification.section-II-4-part-1-option-2-comment" class="ng-scope">Option B was not used in declaration(s) of conformity.
									However, HFCs were reported in section 12A of the report and the veracity of the reported data pursuant to Art. 26(7) of Regulation (EU) 2024/573 was confirmed by the auditor.
									Comment by the auditor:</span>
								<br></br>
								<input type="text">
									<xsl:attribute name="value">
	...
	<xsl:template name="EquipmentHFCsSection5">
		...
		<div class="hfcs-verification-section ng-scope" ng-include=""><div class="ng-scope">
			...
			<div class="ng-scope">				
				<a id="bulk-hfcs-verification-verification-report" target="_blank" class="ng-binding">
					<xsl:attribute name="href">
						<xsl:value-of select="../EquipmentHFCs/section_II_5/VerificationReport/Url"/>
					</xsl:attribute>
