...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<xsl:variable name="labelsUrl">
		<xsl:choose>
			<xsl:when test="doc-available(concat($xmlPath, 'fgases-labels-2018-', $labelsLanguage ,'.xml'))">
				<xsl:value-of select="concat($xmlPath, 'fgases-labels-2018-', $labelsLanguage ,'.xml')"/>
			</xsl:when>
			<xsl:otherwise>
	...
	<xsl:template match="/">
		<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				...
				<xsl:for-each select="FGasesReporting/GeneralReportData">
					<xsl:call-template name="GeneralReportData" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F1_S1_4_ProdImpExp">
					<xsl:call-template name="F1_S1_4_ProdImpExp" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F2_S5_exempted_HFCs">
					<xsl:call-template name="F2_S5_exempted_HFCs" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F3A_S6A_IA_HFCs">
					<xsl:call-template name="F3A_S6A_IA_HFCs" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F6_FUDest">
					<xsl:call-template name="F6_FUDest" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F4_S9_IssuedAuthQuata">
					<xsl:call-template name="F4_S9_IssuedAuthQuata" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F5_S10_Auth_NER">
					<xsl:call-template name="F5_S10_Auth_NER" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F7_s11EquImportTable">
					<xsl:call-template name="F7_s11EquImportTable" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F8_S12">
					<xsl:call-template name="F8_S12" ></xsl:call-template>
				</xsl:for-each>
				<xsl:for-each select="FGasesReporting/F9_S13">
					<xsl:call-template name="F9_S13" ></xsl:call-template>
				</xsl:for-each>
				<xsl:apply-templates />
	...
	<xsl:template name="GeneralReportData">
	...
	<xsl:template match="Gas[position() mod $pagingLimit = 1]"  name="section">
		...
		<!--<xsl:if test="$section=''">
			<xsl:variable name="section" select="0"/>
		</xsl:if>
		
		<xsl:if test="not($section)">
			<xsl:variable name="section" select="0"></xsl:variable>
		</xsl:if>-->
		<!-- Section 1 -->
		<!--<xsl:message>-->
	                        ...
	                        <xsl:for-each select="$gases">
	                          <xsl:variable name="isHfc"><xsl:value-of select="fgas:isHfcBased(current()/GasCode, /FGasesReporting)" /></xsl:variable>
							   <xsl:if test="$isHfc = true()">
	                            ...
	                            <xsl:call-template name="formatValue"><xsl:with-param name="num" select="tr_02A/CountrySpecific/Country[CountryId = $countryId]/Amount/text()"/></xsl:call-template>
									</td>
	                           </xsl:if>
	                           <xsl:if test="$isHfc != true()">
	                                 <td  class="num_cell">
	                        ...
	                        <xsl:for-each select="$gases">
	                          <xsl:variable name="isHfc"><xsl:value-of select="fgas:isHfcBased(current()/GasCode, /FGasesReporting)" /></xsl:variable>
							   <xsl:if test="$isHfc = true()">
	                            ...
	                            <xsl:call-template name="formatValue"><xsl:with-param name="num" select="tr_02App/CountrySpecific/Country[CountryId = $countryId]/Amount/text()"/></xsl:call-template>
									</td>
	                           </xsl:if>
	                           <xsl:if test="$isHfc != true()">
	                                 <td  class="num_cell">
	                        ...
	                        <xsl:for-each select="$gases">
	                          <xsl:variable name="isHfc"><xsl:value-of select="fgas:isHfcBased(current()/GasCode, /FGasesReporting)" /></xsl:variable>
							   <xsl:if test="$isHfc = true()">
	                            ...
	                            <xsl:call-template name="formatValue"><xsl:with-param name="num" select="tr_02C/CountrySpecific/Country[CountryId = $countryId]/Amount/text()"/></xsl:call-template>
									</td>
	                           </xsl:if>
	                           <xsl:if test="$isHfc != true()">
	                                 <td  class="num_cell">
	                        ...
	                        <xsl:for-each select="$gases">
	                          <xsl:variable name="isHfc"><xsl:value-of select="fgas:isHfcBased(current()/GasCode, /FGasesReporting)" /></xsl:variable>
							   <xsl:if test="$isHfc = true()">
	                            ...
	                            <xsl:call-template name="formatValue"><xsl:with-param name="num" select="tr_02D/CountrySpecific/Country[CountryId = $countryId]/Amount/text()"/></xsl:call-template>
									</td>
	                           </xsl:if>
	                           <xsl:if test="$isHfc != true()">
	                                 <td  class="num_cell">
	                        ...
	                        <xsl:for-each select="$gases">
	                          <xsl:variable name="isHfc"><xsl:value-of select="fgas:isHfcBased(current()/GasCode, /FGasesReporting)" /></xsl:variable>
							   <xsl:if test="$isHfc = true()">
	                            ...
	                            <xsl:call-template name="formatValue"><xsl:with-param name="num" select="tr_02E/CountrySpecific/Country[CountryId = $countryId]/Amount/text()"/></xsl:call-template>
									</td>
	                           </xsl:if>
	                           <xsl:if test="$isHfc != true()">
	                                 <td  class="num_cell">
	                 ...
	                 <tr> 
	                        ...
	                        <xsl:for-each select="$gases">
	                          <xsl:variable name="isHfc"><xsl:value-of select="fgas:isHfcBased(current()/GasCode, /FGasesReporting)" /></xsl:variable>
							   <xsl:if test="$isHfc = true()">
	                                <td  class="num_cell">                                                                
	                            		<xsl:call-template name="formatValue"><xsl:with-param name="num" select="tr_03App/CountrySpecific/Country[CountryId = $countryId]/Amount/text()"/></xsl:call-template>
									</td>
	                           </xsl:if>
	                           <xsl:if test="$isHfc != true()">
	                                 <td  class="num_cell">
	...
	<xsl:template name="F1_S1_4_ProdImpExp">
	...
	<xsl:template name="F2_S5_exempted_HFCs">
	...
	<xsl:template name="F3A_S6A_IA_HFCs">
	...
	<xsl:template name="F4_S9_IssuedAuthQuata">
	...
	<xsl:template name="F5_S10_Auth_NER">
			...
			<table class="tableSizeLimit table table-hover table-bordered">
				...
				<tbody>
					<tr>
						...
						<td class="total">
							<xsl:call-template name="formatValue"><xsl:with-param name="num" select="xs:string( sum(./SumOfAllHFCsS1/tr_10A/Amount[Amount != '']/Amount) )"/></xsl:call-template>
						</td>
						<td class="total">
							<xsl:call-template name="formatValue"><xsl:with-param name="num" select="xs:string( sum(./SumOfAllHFCsS2/tr_10A/Amount[Amount != '']/Amount) )"/></xsl:call-template>
						</td>
						<td class="total">
	...
	<xsl:template name="F7_s11EquImportTable">
