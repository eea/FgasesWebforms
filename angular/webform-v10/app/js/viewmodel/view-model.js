...
(function() {
    angular.module('FGases.viewmodel').factory('viewModel', [
        ...
        'ViewModelObjectBase', 'ViewModelActivities', 'ViewModelSheet1', 'ViewModelSheet2', 'ViewModelSheet2a','ViewModelSheet3',
        'ViewModelSheet4', 'ViewModelSheet6', 'ViewModelSheet7', 'ViewModelSheet8', 'ViewModelSheet9', 'ViewModelSubmission',
        'tradePartnerCompanyMatcher', 'objectUtil', 'arrayUtil',

        function (ViewModelObjectBase, ViewModelActivities, ViewModelSheet1, ViewModelSheet2, ViewModelSheet2a, ViewModelSheet3,
                    ViewModelSheet4, ViewModelSheet6, ViewModelSheet7, ViewModelSheet8, ViewModelSheet9,
            ...
            function ViewModel() {
                ...
                this.sheet2a = new ViewModelSheet2a(this);
                ...
                this.sheet9 = new ViewModelSheet9(this);
