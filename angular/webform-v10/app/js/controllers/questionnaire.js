(function() {
    angular.module('FGases.controllers').controller("questionnaire", 
        ...
        function($scope, $window, $rootScope, dataRepository, languageChanger, $sce, $location, $filter, $translate,
            ...
            sheet1Validator, sheet2Validator, sheet2aValidator, sheet3Validator, sheet4Validator, sheet6aValidator, sheet6bValidator,
            ...
            $scope.onInstanceReady = function (instance) {
                if ($scope.instance.FGasesReporting.GeneralReportData['@status'] == 'copied') {
                ...
                if ($scope.instance.FGasesReporting.GeneralReportData.Company['@status'] === 'incomplete') {
                    ...
                    $scope.loadCompanyData(companyId);
                } else {
                    $scope.companyInfoConfirmed = true;
                   // $scope.onCompanyDataLoaded();
                    $scope.loadCompanyData(companyId); //load company data always from BDR and not from XML
                }
                $scope.filteredReportedGases = $scope.instance.FGasesReporting.ReportedGases.filter($scope.filterNonFlourGases);
            ...
            $scope.InhalationGasGroupId = FormConstants.InhalationGasGroupId;
            $scope.NF3GasGroupId = FormConstants.NF3GasGroupId;
            ...
            $scope.NonFluorinatedRefrigerantsGasGroupId = FormConstants.NonFluorinatedRefrigerantsGasGroupId;
            //there is no 6
             ...
             */
            $scope.filterByNonFluorRefrig = function (gas) {
                return ($scope.NonFluorinatedRefrigerantsGasGroupId.indexOf(gas.GasGroupId) !== -1);
            };
            ...
            $scope.loadCompanyData = function(companyId) {
                ...
                dataRepository.getCompanyData(companyId).error(function() {
                    ...
                    if (organisation) {
                        ...
                        company.CompanyId = organisation.id;
                        ...
                        company.EORI = organisation.eori_number;
                        if (organisation.businessProfile || organisation.types) {
                            businessprofile = organisation.businessProfile.split(',');
                            types = organisation.types.split(',');
                            $scope.CompanyExtraData = {
                        ...
                        if (!angular.isUndefined(organisation.euLegalRepresentativeCompany) && !isEmpty(organisation.euLegalRepresentativeCompany)) {
                            ...
                            company.EuLegalRepresentativeCompany.EORI = organisation.euLegalRepresentativeCompany.eori_number;
                        }
            ...
            $scope.loadAuthorisationData = function(companyId) {
                ...
                dataRepository.getAuthorisationData(
                    companyId,
                    transactionYearProvider.getTransactionYear(),
            ...
            $scope.modifyCompanyInfo = function() {
                if (confirm('The reporting will end at this stage and you are forwarded to another webpage where company information can be changed. \n Are you sure you want to proceed with modifying company information?')) {
                    ...
                    $scope.saveInstance();
                    window.location = "https://fgas-licensing.ec.europa.eu/";
                }
            };
            ...
            $scope.activitySelectionChanged = function(activity) {
                ...
                if (activity === 'NIL-Report') {
                    if ($scope.instance.FGasesReporting.GeneralReportData.Activities[activity]) {
                        $scope.removeAllGases();
                    } else { //if NIL-Report is deactivated, check if NIL-sub100 is activated
                        var childNILReport_activity = $scope.activityFieldDepedencyMap[activity].dependents;
                        if (childNILReport_activity && childNILReport_activity.length > 0) {
                            if ($scope.instance.FGasesReporting.GeneralReportData.Activities[childNILReport_activity[0]]) { //if NIL-sub100 is activated
                                $scope.instance.FGasesReporting.GeneralReportData.Activities[childNILReport_activity[0]] = false;
                            }
                        }
                    }
                    return
                ...
                // QC1071 && QC1072
                if (activity === 'I-HFC' || activity === 'Eq-I-RACHP-HFC' || activity === 'Eq-I-other') {
                    if ($scope.CompanyExtraData && $scope.instance.FGasesReporting.GeneralReportData.Activities[activity]) {
                        types = $scope.CompanyExtraData.types;
                        if (activity === 'I-HFC' && ((types.indexOf('FGAS_PRODUCER_IMPORTER_HFCS') < 0) && types.indexOf('PRODUCER_IMPORTER_HFCS') < 0) ) {
                            alert('You have selected "bulk HFC imports" for your report on last year\'s activities. However, according to your business profile in the F-Gas portal, your company is not an importer of bulk HFCs. Please double-check your selection of activities. If you conclude you are indeed an importer of bulk HFCs, please proceed with your report here and update later your business profile in the F-Gas Portal.');
    } else if ((activity === 'Eq-I-RACHP-HFC' || activity === 'Eq-I-other') && ((types.indexOf('FGAS_IMPORTER_OF_EQUIPMENT_HFCS') < 0) && types.indexOf('IMPORTER_OF_EQUIPMENT_HFCS') < 0)) {
                            alert('You have selected "imports of products/equipment containing F-gases" for your report on last year\'s activities. However, according to your business profile in the F-Gas portal, your company is not an importer of products or equipment. Please double-check your selection of activities. If you conclude you are indeed an importer of products/equiopment containing F-gases, please proceed with your report here and update later your business profile in the F-Gas Portal.');
                        }
                    }
                }
                // End of QC1071 && QC1072
                if (!$scope.instance.FGasesReporting.GeneralReportData.Activities[activity]) {
                        ...
                        if (!($scope.instance.FGasesReporting.GeneralReportData.Activities['I'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['E'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['D'])) {
                            ...
                            if (unspecifiedMixIndex >= 0) {
                                ...
                                for (; gasIndex < $scope.instance.FGasesReporting.ReportedGases.length &&
                                    $scope.instance.FGasesReporting.ReportedGases[gasIndex].GasId != FormConstants.UnspecifiedGasMixId; gasIndex++) {}
                    ...
                    if ($scope.instance.FGasesReporting.GeneralReportData.Activities['Eq-I-RACHP-HFC']) {
                        $scope.reInitSheet8();
                    };
            ...
            $scope.activityFieldDepedencyMap = {
                'P-HFC': { 'clearStatements': [], 'dependents': ['P-HFC'] },
                'P-other': { 'clearStatements': [], 'dependents': ['P-other'] },
                'P': {
                    'clearStatements': [{
                        'condition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["P"] == false',
                        'fields': [
                            { 'form': 'F1_S1_4_ProdImpExp', 'rows': ['tr_01A', 'tr_01Aa', 'tr_01A_a', 'tr_01A_a_own', 'tr_01A_a_other', 'tr_01Ab', 'tr_01A_fs', 'tr_01A_ex', 'tr_01B', 'tr_01C', 'tr_01D', 'tr_01E'] },
                            { 'form': 'F1_S1_4_ProdImpExp', 'subForm': 'Totals', 'rows': ['tr_01ASumAllGases', 'tr_01ASumAllGasesCO2Eq'] },
                            { 'form': 'F1_S1_4_ProdImpExp', 'subForm': 'tr_01A_fs_Countries', 'rows': ['Country'] }
                        ]
                    }],
                ...
                'I': {
                    'clearStatements': [{
                        ...
                        'fields': [
                            { 'form': 'F1_S1_4_ProdImpExp', 'rows': ['tr_02A', 'tr_02E', 'tr_02B', 'tr_02App', 'tr_02C', 'tr_02D', 'tr_02G', 'tr_02H', 'tr_02I'] },
                            { 'form': 'F1_S1_4_ProdImpExp', 'subForm': 'Totals', 'rows': ['tr_02ASumAllGases', 'tr_02ASumAllGasesCO2Eq'] },
                            { 'form': 'F1_S1_4_ProdImpExp', 'subForm': 'tr_02A_Countries', 'rows': ['Country'] }
                        ]
                    }],
                    'dependents': ['P_I_E', 'P_I', 'P_I_E_Calculated']
                },
                'P_I': {
                    'clearStatements': [{
                            ...
                            'fields': [
                                ...
                                { 'form': 'F3A_S6A_IA_HFCs', 'rows': ['tr_06A', 'tr_06B', 'tr_06C', 'tr_06D', 'tr_06E', 'tr_06F', 'tr_06G', 'tr_06H', 'tr_06I', 'tr_06J', 'tr_06K', 'tr_06L', 'tr_06M', 'tr_06N', 'tr_06O', 'tr_06P', 'tr_06Q', 'tr_06R', 'tr_06S', 'tr_06S1', 'tr_06S2', 'tr_06T', 'tr_06U', 'tr_06V', 'tr_06W', 'tr_06X'] }
                            ]
                        },
                        {
                ...
                'RQ': {
                    'clearStatements': [{
                        'condition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["RQ"] == false',
                        'fields': [
                            { 'form': 'F2a_S5a_exempted_HFCs', 'rows': ['tr_05aD', 'tr_05aE'] },
                        ]
                    },
                    ]
                },
                'RH': {
                    'clearStatements': [{
                        'condition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["RH"] == false',
                        'fields': [
                            { 'form': 'F2a_S5a_exempted_HFCs', 'rows': ['tr_05aF'] },
                        ]
                    },
                    ]
                },
                'E': {
                    'clearStatements': [{
                        ...
                        'fields': [
                            { 'form': 'F1_S1_4_ProdImpExp', 'rows': ['tr_03A', 'tr_03App', 'tr_03B', 'tr_03C', 'tr_03D', 'tr_03E', 'tr_03F', 'tr_03G', 'tr_03H', 'tr_03I'], 'calculatedFields': ['tr_01K', 'tr_04M', 'tr_06X'] },
                            { 'form': 'F1_S1_4_ProdImpExp', 'subForm': 'Totals', 'rows': ['tr_03ASumAllGases', 'tr_03ASumAllGasesCO2Eq', 'tr_03AppSumAllGases', 'tr_03AppSumAllGasesCO2Eq', 'tr_03GSumAllGases', 'tr_03GSumAllGasesCO2Eq', 'tr_03HSumAllGases', 'tr_03HSumAllGasesCO2Eq'] },
                            { 'form': 'F1_S1_4_ProdImpExp', 'subForm': 'tr_03A_Countries', 'rows': ['Country'] }
                        ]
                    }],
                ...
                P_I_E: {
                    clearStatements: [{
                        ...
                        fields: [{
                            ...
                            rows: [
                                'tr_01F', 'tr_01G', 'tr_01H', 'tr_01I', 'tr_01J', 'tr_01K', 'tr_01A_fs1', 'tr_01A_fs2',
                ...
                'RC': {
                    'clearStatements': [{
                        'condition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["RC"] == false',
                        'fields': [{
                            'form': 'F1_S1_4_ProdImpExp',
                            'rows': ['tr_04A', 'tr_04Aa', 'tr_04B', 'tr_04C', 'tr_04D', 'tr_04E', 'tr_04F', 'tr_04Fa', 'tr_04G', 'tr_04H', 'tr_04I', 'tr_04J', 'tr_04K',],
                            'calculatedFields': ['tr_01K', 'tr_03C', 'tr_04M']
                        },
                        {
                ...
                'FU': { 'clearStatements': [{ 'condition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["FU"] == false', 'fields': [{ 'form': 'F6_FUDest', 'rows': ['tr_07A', 'tr_07Aa'] }, { 'form': 'F6_FUDest', 'subForm': 'Totals', 'rows': ['tr_07ASumAllGases', 'tr_07ASumAllGasesCO2Eq'] }] }] },
                'D': {
                    'clearStatements': [{
                        'condition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["D"] == false',
                        'fields': [{
                                'form': 'F6_FUDest',
                                'rows': ['tr_8A', 'tr_8A1', 'tr_8A1i', 'tr_8A1ia', 'tr_8A1ii', 'tr_8A1iia', 'tr_8A1iii', 'tr_8A1iiia', 'tr_8A1iv', 'tr_8A1iva', 'tr_8A1v', 'tr_8A1vi', 'tr_8A1other', 'tr_8A1othera', 'tr_8A2', 'tr_8A2i', 'tr_8A2ii', 'tr_8A2other', 'tr_8A2othera', 'tr_8Aa', 'tr_8Ba', 'tr_8Ba1', 'tr_8Ba1i', 'tr_8Ba1ia', 'tr_8Ba1ii', 'tr_8Ba1iia', 'tr_8Ba1iii', 'tr_8Ba1other', 'tr_8Ba1othera', 'tr_8Ba2', 'tr_8Ba2other', 'tr_8Ba2othera', 'tr_8Baa', 'tr_8Bb', 'tr_8Bb1', 'tr_8Bb1i', 'tr_8Bb1ia', 'tr_8Bb1ii', 'tr_8Bb1iia', 'tr_8Bb1iii', 'tr_8Bb1other', 'tr_8Bb1othera', 'tr_8Bb2', 'tr_8Bb2other', 'tr_8Bb2othera', 'tr_8Bba', 'tr_8C', 'tr_8C1', 'tr_8C1other', 'tr_8C1othera', 'tr_8C2', 'tr_8C2other', 'tr_8C2othera', 'tr_8Ca', 'tr_8D', 'tr_8Da', 'tr_8E', 'tr_8F']
                            },
                            {
                                'form': 'F6_FUDest',
                                'subForm': 'Totals',
                    ...
                    onPostExecute: function () {
                        if ($scope.instance.FGasesReporting.GeneralReportData.Activities["D"]) {
                            return;
                        }

                        $scope.instance.FGasesReporting.F6_FUDest.transactionsConfirmed = false;
                        var transactionSelection = $scope.instance.FGasesReporting.F6_FUDest.UISelectedTransactions;
                ...
                'Eq-I-RACHP-HFC': {
                    ...
                    onPostExecute: function(instance) {
                        // reset sheet8
                        if (!$scope.instance.FGasesReporting.GeneralReportData.Activities['Eq-I-RACHP-HFC']) {
                            instance.FGasesReporting.F8_S12 = clone($scope.getInstanceByPath('emptyInstance', 'FGasesReporting.F8_S12'));
                            instance.FGasesReporting.F8_S12.Gas = [];
                            instance.FGasesReporting.F8_S12.tr_12A_TradePartners = { Partner: [] };
                            instance.FGasesReporting.F8_S12.tr_12aA_TradePartners = { Partner: [] };
                            instance.FGasesReporting.F8_S12.tr_12B_TradePartners = { Partner: [] };
                            instance.FGasesReporting.F8_S12.tr_12aB_TradePartners = { Partner: [] };

                            // reset sheet9
                            instance.FGasesReporting.F9_S13 = clone($scope.getInstanceByPath('emptyInstance', 'FGasesReporting.F9_S13'));
                        }
                    }
                },
                'Eq-I-other': {
                ...
                'Eq-I': {
                    'clearStatements': [{
                        ...
                        'fields': [
                            { 'form': 'F7_s11EquImportTable', 'rows': ['tr_11A', 'tr_11A1', 'tr_11A1a', 'tr_11A1a1', 'tr_11A1a2', 'tr_11A1a3', 'tr_11A1a4', 'tr_11A1b', 'tr_11A1b1', 'tr_11A1b2', 'tr_11A1b3', 'tr_11A1b4', 'tr_11A1c', 'tr_11A1c1', 'tr_11A1c2', 'tr_11A1c3', 'tr_11A1c4', 'tr_11A2', 'tr_11A2a', 'tr_11A2a1', 'tr_11A2a1i', 'tr_11A2a1ii', 'tr_11A2a1iii', 'tr_11A2a2', 'tr_11A2a2i', 'tr_11A2a2ii', 'tr_11A2a2iii', 'tr_11A2a3', 'tr_11A2a3i', 'tr_11A2a3ii', 'tr_11A2a3iii', 'tr_11A2b', 'tr_11A2b1', 'tr_11A2b1i', 'tr_11A2b1ii', 'tr_11A2b1iii', 'tr_11A2b2', 'tr_11A2b2i', 'tr_11A2b2ii', 'tr_11A2b2iii', 'tr_11A2b3', 'tr_11A2b3i', 'tr_11A2b3ii', 'tr_11A2b3iii', 'tr_11B', 'tr_11B1', 'tr_11B2', 'tr_11B3', 'tr_11B4', 'tr_11B5', 'tr_11C', 'tr_11C1', 'tr_11C1a', 'tr_11C1b', 'tr_11C2', 'tr_11C2a', 'tr_11C2b', 'tr_11D', 'tr_11E', 'tr_11E1', 'tr_11E2', 'tr_11E3', 'tr_11E4', 'tr_11F', 'tr_11F1', 'tr_11F2', 'tr_11F3', 'tr_11F4', 'tr_11F5', 'tr_11F6', 'tr_11F7', 'tr_11F8', 'tr_11F9', 'tr_11G', 'tr_11H', 'tr_11H1', 'tr_11H2', 'tr_11H3', 'tr_11H4', 'tr_11I', 'tr_11J', 'tr_11J1', 'tr_11J2', 'tr_11K', 'tr_11L', 'tr_11L1', 'tr_11L2', 'tr_11L3', 'tr_11M', 'tr_11M1', 'tr_11M2', 'tr_11M3', 'tr_11M4', 'tr_11M5', 'tr_11N', 'tr_11O', 'tr_11O1', 'tr_11O2', 'tr_11O3', 'tr_11O4', 'tr_11P', 'tr_11Q', 'tr_11R'] },
                            { 'form': 'F7_s11EquImportTable', 'subForm': 'AmountOfImportedEquipment', 'rows': ['tr_11A', 'tr_11A1', 'tr_11A1a', 'tr_11A1a1', 'tr_11A1a2', 'tr_11A1a3', 'tr_11A1a4', 'tr_11A1b', 'tr_11A1b1', 'tr_11A1b2', 'tr_11A1b3', 'tr_11A1b4', 'tr_11A1c', 'tr_11A1c1', 'tr_11A1c2', 'tr_11A1c3', 'tr_11A1c4', 'tr_11A2', 'tr_11A2a', 'tr_11A2a1', 'tr_11A2a1i', 'tr_11A2a1ii', 'tr_11A2a1iii', 'tr_11A2a2', 'tr_11A2a2i', 'tr_11A2a2ii', 'tr_11A2a2iii', 'tr_11A2a3', 'tr_11A2a3i', 'tr_11A2a3ii', 'tr_11A2a3iii', 'tr_11A2b', 'tr_11A2b1', 'tr_11A2b1i', 'tr_11A2b1ii', 'tr_11A2b1iii', 'tr_11A2b2', 'tr_11A2b2i', 'tr_11A2b2ii', 'tr_11A2b2iii', 'tr_11A2b3', 'tr_11A2b3i', 'tr_11A2b3ii', 'tr_11A2b3iii', 'tr_11B', 'tr_11B1', 'tr_11B2', 'tr_11B3', 'tr_11B4', 'tr_11B5', 'tr_11C', 'tr_11C1', 'tr_11C1a', 'tr_11C1b', 'tr_11C2', 'tr_11C2a', 'tr_11C2b', 'tr_11D', 'tr_11E', 'tr_11E1', 'tr_11E2', 'tr_11E3', 'tr_11E4', 'tr_11F', 'tr_11F1', 'tr_11F2', 'tr_11F3', 'tr_11F4', 'tr_11F5', 'tr_11F6', 'tr_11F7', 'tr_11F8', 'tr_11F9', 'tr_11G', 'tr_11H', 'tr_11H1', 'tr_11H2', 'tr_11H3', 'tr_11H4', 'tr_11I', 'tr_11J', 'tr_11J1', 'tr_11J2', 'tr_11K', 'tr_11L', 'tr_11L1', 'tr_11L2', 'tr_11L3', 'tr_11M', 'tr_11M1', 'tr_11M2', 'tr_11M3', 'tr_11M4', 'tr_11M5', 'tr_11N', 'tr_11O', 'tr_11O1', 'tr_11O2', 'tr_11O3', 'tr_11O4', 'tr_11P', 'tr_11Q', 'tr_11R'] },
                            { 'form': 'F7_s11EquImportTable', 'subForm': 'SumOfAllGasesS1', 'rows': ['tr_11A1a1', 'tr_11A1a2', 'tr_11A1a3', 'tr_11A1a4', 'tr_11A1b1', 'tr_11A1b2', 'tr_11A1b3', 'tr_11A1b4', 'tr_11A1c1', 'tr_11A1c2', 'tr_11A1c3', 'tr_11A1c4', 'tr_11A2a1i', 'tr_11A2a1ii', 'tr_11A2a1iii', 'tr_11A2a2i', 'tr_11A2a2ii', 'tr_11A2a2iii', 'tr_11A2a3i', 'tr_11A2a3ii', 'tr_11A2a3iii', 'tr_11A2b1i', 'tr_11A2b1ii', 'tr_11A2b1iii', 'tr_11A2b2i', 'tr_11A2b2ii', 'tr_11A2b2iii', 'tr_11A2b3i', 'tr_11A2b3ii', 'tr_11A2b3iii', 'tr_11B1', 'tr_11B2', 'tr_11B3', 'tr_11B4', 'tr_11B5', 'tr_11C1a', 'tr_11C1b', 'tr_11C2a', 'tr_11C2b', 'tr_11D', 'tr_11E1', 'tr_11E2', 'tr_11E3', 'tr_11E4', 'tr_11F1', 'tr_11F2', 'tr_11F3', 'tr_11F4', 'tr_11F5', 'tr_11F6', 'tr_11F7', 'tr_11F8', 'tr_11F9', 'tr_11H1', 'tr_11H2', 'tr_11H3', 'tr_11H4', 'tr_11I', 'tr_11J1', 'tr_11J2', 'tr_11K', 'tr_11L1', 'tr_11L2', 'tr_11L3', 'tr_11M1', 'tr_11M2', 'tr_11M3', 'tr_11M4', 'tr_11M5', 'tr_11N', 'tr_11O1', 'tr_11O2', 'tr_11O3', 'tr_11O4', 'tr_11P', 'tr_11Q', 'tr_11R'] },
                            { 'form': 'F7_s11EquImportTable', 'subForm': 'SumOfAllGasesS2', 'rows': ['tr_11A1a1', 'tr_11A1a2', 'tr_11A1a3', 'tr_11A1a4', 'tr_11A1b1', 'tr_11A1b2', 'tr_11A1b3', 'tr_11A1b4', 'tr_11A1c1', 'tr_11A1c2', 'tr_11A1c3', 'tr_11A1c4', 'tr_11A2a1i', 'tr_11A2a1ii', 'tr_11A2a1iii', 'tr_11A2a2i', 'tr_11A2a2ii', 'tr_11A2a2iii', 'tr_11A2a3i', 'tr_11A2a3ii', 'tr_11A2a3iii', 'tr_11A2b1i', 'tr_11A2b1ii', 'tr_11A2b1iii', 'tr_11A2b2i', 'tr_11A2b2ii', 'tr_11A2b2iii', 'tr_11A2b3i', 'tr_11A2b3ii', 'tr_11A2b3iii', 'tr_11B1', 'tr_11B2', 'tr_11B3', 'tr_11B4', 'tr_11B5', 'tr_11C1a', 'tr_11C1b', 'tr_11C2a', 'tr_11C2b', 'tr_11D', 'tr_11E1', 'tr_11E2', 'tr_11E3', 'tr_11E4', 'tr_11F1', 'tr_11F2', 'tr_11F3', 'tr_11F4', 'tr_11F5', 'tr_11F6', 'tr_11F7', 'tr_11F8', 'tr_11F9', 'tr_11H1', 'tr_11H2', 'tr_11H3', 'tr_11H4', 'tr_11I', 'tr_11J1', 'tr_11J2', 'tr_11K', 'tr_11L1', 'tr_11L2', 'tr_11L3', 'tr_11M1', 'tr_11M2', 'tr_11M3', 'tr_11M4', 'tr_11M5', 'tr_11N', 'tr_11O1', 'tr_11O2', 'tr_11O3', 'tr_11O4', 'tr_11P', 'tr_11Q', 'tr_11R'] }
                        ]
                    }],
                    onPostExecute: function() {
                ...
                'RQA': {
                    'clearStatements': [{
                        'condition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["RQA"] == false',
                        'fields': [
                        {
                            'form': 'F4_S9_IssuedAuthQuata',
                            'rows': ['tr_09A', 'tr_09A_add', 'tr_09B', 'tr_09C', 'tr_09D', 'tr_09E', 'tr_09F']
                    ...
                    onPostExecute: function(instance) {
                        if ($scope.instance.FGasesReporting.GeneralReportData.Activities["RQA"]) {
                            return;
                        } else {
                            $scope.instance.FGasesReporting.F4_S9_IssuedAuthQuata.NilReportConfirmed = false;
                        }
                    }
                },
                'NIL-Report': {
            ...
            //updates ReportedGases values with fgases.gases.xml information
            $scope.updateReportedGasesValues = function () {
                var allGases = viewModel.getAvailableGases();
                var reportedGases = viewModel.getReportedGases();
                for (var i = 0; i < reportedGases.length; i++) {
                    var selectedGasesA = allGases.filter(a => { return a.Code === reportedGases[i].Code });
                    if (selectedGasesA.length > 0) {
                        var selectedGas = selectedGasesA[0];
                        var gasFromList = angular.copy(selectedGas);
                        reportedGases[i] = $scope.fillReportedGas(reportedGases[i], gasFromList);
                    }
                }
            };
                        ...
                        for (var j = 0; j < statement.fields.length; j++) {
                            ...
                            for (var k = 0; k < statement.fields[j].rows.length; k++) {
                                ...
                                for (var l = 0; l < column.length; l++) {
                                    ...
                                    if (angular.isDefined(gasRow.totalAmountForRow)) {
                                        gasRow.totalAmountForRow = null;
                                    }   
                                    ...
                                    } else if (angular.isDefined(gasRow.CountrySpecific)) {
                                        //clear also countryspecific values
                                        if (angular.isDefined(gasRow.CountrySpecific.Country) && !(gasRow.CountrySpecific.Country === null) ) {
                                            gasRow.CountrySpecific.Country = null;
                                            /*for (var n = 0; n < gasRow.CountrySpecific.Country.length; n++) {
                                                gasRow.CountrySpecific.Country[n].Amount = null;
                                                if (angular.isDefined(gasRow.CountrySpecific.Country[n].Comment)) {
                                                    gasRow.CountrySpecific.Country[n].Comment = null;
                                                }
                                            }*/
            ...
            // function to remove all gases from reported gases
            $scope.removeAllGases = function () {
                //first delete from reportedgases lists
                if ($scope.instance.FGasesReporting.ReportedGases.length > 0) {
                    $scope.instance.FGasesReporting.ReportedGases = [];
                }
                //then delete general report data gases
                if ($scope.instance.FGasesReporting.GeneralReportData.HFCs.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.HFCs.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.PFCs.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.PFCs.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.SF6.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.SF6.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.Inhalation.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.Inhalation.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.NF3.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.NF3.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.UnsaturatedHFCsHCFC.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.UnsaturatedHFCsHCFC.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.FluorinatedEthersAlcohols.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.FluorinatedEthersAlcohols.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.OtherPrefluorinatedCompounds.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.OtherPrefluorinatedCompounds.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.NonFluorinatedRefrigerants.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.NonFluorinatedRefrigerants.GasName = [];
                }
                if ($scope.instance.FGasesReporting.GeneralReportData.CommonlyUsedMixtures.GasName.length > 0) {
                    $scope.instance.FGasesReporting.GeneralReportData.CommonlyUsedMixtures.GasName = [];
                }
                ...
                for (var i = 0; i < $scope.gasIncludingElements.length; i++) {
                    ...
                    $scope.instance.FGasesReporting[element].Gas = [];
                }
                $scope.filteredReportedGases = $scope.instance.FGasesReporting.ReportedGases.filter($scope.filterNonFlourGases);
                $scope.refreshValidations();

                return;
            }; // end of function removeAllGases
            ...
            $scope.isGasHFC23 = function (reportedGas) {
                if (reportedGas.GasId) {
                    return reportedGas.Code != FormConstants.Gas1A_fs1;
                }
                return false;
            };
            ...
            $scope.gasSelectionChanged = function(gasGroup) {
                ...
                if (unspecifiedMixIndex >= 0) {
                    alert('Please note that it is no longer possible to report on unspecified gas mixes. If you do not hold detailed information on the mix of gases, please use your best guess. If necessary, enter a new mixture on the gases tab to be used in this category.');
                ...
                if (previousGasIdsCopy.length > 0) {
                    ...
                    for (var i = 0; i < previousGasIdsCopy.length; i++) {
                        ...
                        for (; j < $scope.instance.FGasesReporting.ReportedGases.length &&
                            $scope.instance.FGasesReporting.ReportedGases[j].GasId != gasId; j++) {}
                    ...
                    for (var i = 0; i < gasIdsCopy.length; i++) {
                        ...
                        var reportedGas = {};
                        reportedGas = $scope.fillReportedGas(reportedGas, gasFromList);
            ...
            // fill the reported gas with extra-information (fgases.gases.xml) 
            $scope.fillReportedGas = function (reportedGas, gasFromList) {
            ...
            $scope.addGasForReporting = function(reportedGas) {
                ...
                for (j = 0; j < $scope.gasIncludingElements.length; j++) {
                    ...
                    if ($scope.instance.FGasesReporting[element].Gas[lastIndex]) {
                    ...
                    if (angular.isDefined(tradePartnerElement)) {
                        ...
                        for (var k = 0; k < tradePartnerElement.length; k++) {
                            ...
                            if (tradePartnerElement[k] == 'tr_01A_a_other') {
                                tradePartnerDefinitionElement = tradePartnerElement[k] + '_ExtDestruction';
                            }
                ...
                if ($scope.containsHFC(reportedGas)) {
                    ...
                    var F1_S1_4_ProdImpExpTrCountries = {
                    ...
                    for (var section in F1_S1_4_ProdImpExpTrCountries) {
                        if ($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp[section].Country != null && $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp[section].Country.constructor === Array) {
                            var countries = $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp[section].Country;
                            if (countries.length > 0) {
                                for (var i = 0; i < F1_S1_4_ProdImpExpTrCountries[section].length; i++) {
                                    for (var c = 0; c < countries.length; c++) {
                                        var country = countries[c];
                                        var countryRow = F1_S1_4_ProdImpExpTrCountries[section][i];

                                        if (countryRow && $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[lastIndex][countryRow]) {
                                            if ($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[lastIndex][countryRow].CountrySpecific.Country == null || $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[lastIndex][countryRow].CountrySpecific.Country == 'undefined') {
                                                $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[lastIndex][countryRow].CountrySpecific.Country = [];
                                            }
                                            ...
                                            $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[lastIndex][countryRow].CountrySpecific.Country.push(newCountry);
                                        }
                                        
                                    }
                                    if (countryRow && $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[lastIndex][countryRow])
                                        $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[lastIndex][countryRow].totalAmountForRow = "";  
                                }
                            }
                        }
                    }
            ...
            $scope.removeTradingPartner = function(form, rootArray, index, gasRow, skipConfirmation) {
                ...
                if (skipConfirmation || confirm("Do you want to delete Trading Partner '" + tradingPartner.CompanyName + "' ?")) {
                    ...
                    if ($scope.instance.FGasesReporting[form].Gas) {
                        for (var i = 0; i < $scope.instance.FGasesReporting[form].Gas.length; i++) {
                            var row = $scope.instance.FGasesReporting[form].Gas[i][gasRow];
                            if (row) {
                                $scope.remove(row.TradePartner, index, row.TradePartner[index]);
            ...
            $scope.getValueForReportedGasAmount = function(gasRow) {
                var retval = gasRow.Amount ? gasRow.Amount : (gasRow.SumOfPartnerAmounts ? gasRow.SumOfPartnerAmounts : (gasRow.totalAmountForRow ? gasRow.totalAmountForRow : 0.0));
                retval = isEmpty(retval) || isNaN(retval) ? 0.0 : parseFloat(retval);
                
                return retval;
            }; // end of function getValueForReportedGasAmount

            $scope.getValueForReportedGasAmountPerCountry = function (gasRow, countryIndex) {
                var retval = gasRow.CountrySpecific.Country[countryIndex].Amount ? gasRow.CountrySpecific.Country[countryIndex].Amount : 0.0;
                retval = isEmpty(retval) || isNaN(retval) ? 0.0 : parseFloat(retval);

                return retval;
            }; // end of function getValueForReportedGasAmount

            $scope.getValueForCountrySpecificReportedGasAmount = function(gasRow) {
                //if CountrySpecific Not Array, we will return zero, as it means, it hasn't been yet initialized and is null.
                //if Array

                if (gasRow.CountrySpecific == null) {
                    return 0.0;
                }else  if (gasRow.CountrySpecific.Country == null) {
                    return 0.0;
                }
                var totalAmount = 0.0;
                
                if (!angular.isArray(gasRow.CountrySpecific.Country)) {
                    gasRow.CountrySpecific.Country = [gasRow.CountrySpecific.Country];
                }

                //so for the given gasRow, we get all countrySpec Reporting, and add it and return it.
                for (var j = 0; j < gasRow.CountrySpecific.Country.length; j++) {
                    if (gasRow.CountrySpecific.Country[j].Amount !== "" && gasRow.CountrySpecific.Country[j].Amount !== null) {
                        totalAmount += parseFloat(gasRow.CountrySpecific.Country[j].Amount); // convert to decimal to avoid sum errors (decimals)
                    }
                }
            ...
            // function to find a value of a gas element for given column and row
            $scope.getValueForReportedGasAmountFromPerCountry = function (gasColumn, gasRow, countryIndex) {
                var retVal = $scope.getGasElementFor(gasColumn, gasRow);
                if (retVal) {
                    retVal = $scope.getValueForReportedGasAmountPerCountry(retVal, countryIndex);
                } else {
                    retVal = 0.0;
                }
                return retVal
            ...
            // Regarding to Taskman #77466 Comment #25
            // 5G = sum(5A) + sum(5B) + sum(5C_exempted) + sum(5D) + sum(5E) + sum(5F)
            // Thus 5I = 5G - sum(5F) => 5I = sum(5A) + sum(5B) + sum(5C_exempted) + sum(5D) + sum(5E) + sum(5F) - sum(5F)
            // Thus 5I = sum(5A) + sum(5B) + sum(5C_exempted) + sum(5D) + sum(5E) for 2015-2017
            var v_tr_05G_formula_2017 = ['tr_05A', '+', 'tr_05B', '+', 'tr_05C', '+', 'tr_05D', '+', 'tr_05E', '+', 'tr_05F', '-', 'tr_05F']
            var v_tr_05G_formula_2018 = ['tr_05A', '+', 'tr_05B', '+', 'tr_05C', '+', 'tr_05D', '+', 'tr_05E', '+', 'tr_05F'];
            ...
            $scope.initFormulas = function() {
                ...
                $scope.formulasForRows = {
                    'tr_01Ab': { 'formula': ['tr_01A', '-', 'tr_01Aa'] },
                    'tr_01A_a': { 'formula': ['tr_01A_a_own', '+', 'tr_01A_a_other'], 'dependents': 'tr_01E' },
                    'tr_01D': { 'formula': ['tr_01B', '+', 'tr_01C'], 'dependents': 'tr_01E' },
                    'tr_01E': { 'formula': ['tr_01A', '-', 'tr_01D', '-', 'tr_01A_a'], 'dependents': ['tr_04M', 'tr_06X'] },
                    'tr_01A_fs2': { 'formula': ['tr_01A_fs', '-', 'tr_01A_fs1'] },
                    'tr_01H': { 'formula': ['tr_01F', '-', 'tr_01G'] },
                    'tr_01K': { 'formula': ['tr_01A', '-', 'tr_01B', '-', 'tr_01C', '+', 'tr_01I', '+', 'tr_02A', '-', 'tr_02B', '+', 'tr_02G', '-', 'tr_02H', '-', 'tr_02I', '-', 'tr_03A', '+', 'tr_04A', '-', 'tr_04F', '-', 'tr_07A'] },
                    ...
                    'tr_04M': { 'formula': ['tr_01E', '+', 'tr_02A', '-', 'tr_02B', '+', 'tr_02G', '-', 'tr_02H', '-', 'tr_02I', '-', 'tr_03B', '+', 'tr_04C', '-' , 'tr_04H'], 'dependents': ['tr_05H'] },
                    'tr_05G': { 'formula': v_tr_05G_formula_2018, 'dependents': ['tr_05I'] },
                    'tr_05H': { 'formula': ['tr_04M'], 'dependents': 'tr_05J' },
                    'tr_05I': { 'formula': ['tr_05A', '+', 'tr_05B', '+', 'tr_05C', '+', 'tr_05D', '+', 'tr_05E'], 'dependents': 'tr_05J' },
                    ...
                    'tr_06X': { 'formula': ['tr_01E', '+', 'tr_02A', '+', 'tr_02G', '-', 'tr_02H', '-', 'tr_03B', '+', 'tr_04B', '-', 'tr_04G', '+', 'tr_04K'] },
                    'tr_06S': { 'formula': ['tr_06S1', '+', 'tr_06S2'], 'dependents': 'tr_06W' },
                    'tr_8A': { 'formula': ['tr_8A1', '+', 'tr_8A2'], 'dependents': ['tr_8D'] },
                    'tr_8A1': { 'formula': ['tr_8A1i', '+', 'tr_8A1ii', '+', 'tr_8A1iii', '+', 'tr_8A1iv', '+', 'tr_8A1v', '+', 'tr_8A1vi', '+', 'tr_8A1other'], 'dependents': ['tr_8A', 'tr_8D'] },
                    'tr_8A2': { 'formula': ['tr_8A2i', '+', 'tr_8A2ii', '+', 'tr_8A2other'], 'dependents': ['tr_8A', 'tr_8D'] },
                    'tr_8Aa': { 'formula': ['tr_8A1ia', '+', 'tr_8A1iia', '+', 'tr_8A1iiia', '+', 'tr_8A1iva', '+', 'tr_8A1othera', '+', 'tr_8A2othera'], 'dependents': ['tr_8Da'] },
                    'tr_8Ba': { 'formula': ['tr_8Ba1', '+', 'tr_8Ba2'], 'dependents': ['tr_8D'] },
                    'tr_8Ba1': { 'formula': ['tr_8Ba1i', '+', 'tr_8Ba1ii', '+', 'tr_8Ba1iii', '+', 'tr_8Ba1other'], 'dependents': ['tr_8Ba', 'tr_8D'] },
                    'tr_8Ba2': { 'formula': ['tr_8Ba2other'], 'dependents': ['tr_8Ba', 'tr_8D'] },
                    'tr_8Baa': { 'formula': ['tr_8Ba1ia', '+', 'tr_8Ba1iia', '+', 'tr_8Ba1othera', '+', 'tr_8Ba2othera'], 'dependents': ['tr_8Da'] },
                    'tr_8Bb': { 'formula': ['tr_8Bb1', '+', 'tr_8Bb2'], 'dependents': ['tr_8D'] },
                    'tr_8Bb1': { 'formula': ['tr_8Bb1i', '+', 'tr_8Bb1ii', '+', 'tr_8Bb1iii', '+', 'tr_8Bb1other'], 'dependents': ['tr_8Bb', 'tr_8D'] },
                    'tr_8Bb2': { 'formula': ['tr_8Bb2other'], 'dependents': ['tr_8Bb', 'tr_8D'] },
                    'tr_8Bba': { 'formula': ['tr_8Bb1ia', '+', 'tr_8Bb1iia', '+', 'tr_8Bb1othera', '+', 'tr_8Bb2othera'], 'dependents': ['tr_8Da'] },
                    'tr_8C': { 'formula': ['tr_8C1', '+', 'tr_8C2'], 'dependents': ['tr_8D'] },
                    'tr_8C1': { 'formula': ['tr_8C1other'], 'dependents': ['tr_8C', 'tr_8D'] },
                    'tr_8C2': { 'formula': ['tr_8C2other'], 'dependents': ['tr_8C', 'tr_8D'] },
                    'tr_8Ca': { 'formula': ['tr_8C1othera', '+', 'tr_8C2othera'], 'dependents': ['tr_8Da'] },
                    'tr_8D': { 'formula': ['tr_8A', '+', 'tr_8Ba', '+', 'tr_8Bb', '+', 'tr_8C'] },
                    'tr_8Da': { 'formula': ['tr_8Aa', '+', 'tr_8Baa', '+', 'tr_8Bba', '+', 'tr_8Ca'] },
                    'tr_11A': { 'formula': ['tr_11A1', '+', 'tr_11A2'], 'dependents': ['tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A1': { 'formula': ['tr_11A1a', '+', 'tr_11A1b', '+', 'tr_11A1c'], 'dependents': ['tr_11A', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A1a': { 'formula': ['tr_11A1a1', '+', 'tr_11A1a2', '+', 'tr_11A1a3', '+', 'tr_11A1a4'], 'dependents': ['tr_11A', 'tr_11A1', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A1b': { 'formula': ['tr_11A1b1', '+', 'tr_11A1b2', '+', 'tr_11A1b3', '+', 'tr_11A1b4'], 'dependents': ['tr_11A', 'tr_11A1', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A1c': { 'formula': ['tr_11A1c1', '+', 'tr_11A1c2', '+', 'tr_11A1c3', '+', 'tr_11A1c4'], 'dependents': ['tr_11A', 'tr_11A1', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2': { 'formula': ['tr_11A2a', '+', 'tr_11A2b'], 'dependents': ['tr_11A', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2a': { 'formula': ['tr_11A2a1', '+', 'tr_11A2a2', '+', 'tr_11A2a3'], 'dependents': ['tr_11A', 'tr_11A2', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2a1': { 'formula': ['tr_11A2a1i', '+', 'tr_11A2a1ii', '+', 'tr_11A2a1iii'], 'dependents': ['tr_11A', 'tr_11A2', 'tr_11A2a', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2a2': { 'formula': ['tr_11A2a2i', '+', 'tr_11A2a2ii', '+', 'tr_11A2a2iii'], 'dependents': ['tr_11A', 'tr_11A2', 'tr_11A2a', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2a3': { 'formula': ['tr_11A2a3i', '+', 'tr_11A2a3ii', '+', 'tr_11A2a3iii'], 'dependents': ['tr_11A', 'tr_11A2', 'tr_11A2a', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2b': { 'formula': ['tr_11A2b1', '+', 'tr_11A2b2', '+', 'tr_11A2b3'], 'dependents': ['tr_11A', 'tr_11A2', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2b1': { 'formula': ['tr_11A2b1i', '+', 'tr_11A2b1ii', '+', 'tr_11A2b1iii'], 'dependents': ['tr_11A', 'tr_11A2', 'tr_11A2b', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2b2': { 'formula': ['tr_11A2b2i', '+', 'tr_11A2b2ii', '+', 'tr_11A2b2iii'], 'dependents': ['tr_11A', 'tr_11A2', 'tr_11A2b', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11A2b3': { 'formula': ['tr_11A2b3i', '+', 'tr_11A2b3ii', '+', 'tr_11A2b3iii'], 'dependents': ['tr_11A', 'tr_11A2', 'tr_11A2b', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11B': { 'formula': ['tr_11B1', '+', 'tr_11B2', '+', 'tr_11B3', '+', 'tr_11B4', '+', 'tr_11B5'], 'dependents': ['tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11C': { 'formula': ['tr_11C1', '+', 'tr_11C2'], 'dependents': ['tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11C1': { 'formula': ['tr_11C1a', '+', 'tr_11C1b'], 'dependents': ['tr_11C', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11C2': { 'formula': ['tr_11C2a', '+', 'tr_11C2b'], 'dependents': ['tr_11C', 'tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11E': { 'formula': ['tr_11E1', '+', 'tr_11E2', '+', 'tr_11E3', '+', 'tr_11E4'], 'dependents': ['tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11F': { 'formula': ['tr_11F1', '+', 'tr_11F2', '+', 'tr_11F3', '+', 'tr_11F4', '+', 'tr_11F5', '+', 'tr_11F6', '+', 'tr_11F7', '+', 'tr_11F8', '+', 'tr_11F9'], 'dependents': ['tr_11G', 'tr_11Q', 'tr_11R'] },
                    'tr_11G': { 'formula': ['tr_11A', '+', 'tr_11B', '+', 'tr_11C', '+', 'tr_11D', '+', 'tr_11E', '+', 'tr_11F'], 'dependents': ['tr_11Q', 'tr_11R'] },
                    'tr_11H': { 'formula': ['tr_11H1', '+', 'tr_11H2', '+', 'tr_11H3', '+', 'tr_11H4'], 'dependents': ['tr_11Q'] },
                    'tr_11J': { 'formula': ['tr_11J1', '+', 'tr_11J2'], 'dependents': ['tr_11Q'] },
                    'tr_11L': { 'formula': ['tr_11L1', '+', 'tr_11L2', '+', 'tr_11L3'], 'dependents': ['tr_11Q'] },
                    'tr_11M': { 'formula': ['tr_11M1', '+', 'tr_11M2', '+', 'tr_11M3', '+', 'tr_11M4', '+', 'tr_11M5'], 'dependents': ['tr_11Q'] },
                    'tr_11O': { 'formula': ['tr_11O1', '+', 'tr_11O2', '+', 'tr_11O3', '+', 'tr_11O4'], 'dependents': ['tr_11Q'] },
                    'tr_11Q': { 'formula': ['tr_11G', '+', 'tr_11H', '+', 'tr_11I', '+', 'tr_11J', '+', 'tr_11K', '+', 'tr_11L', '+', 'tr_11M', '+', 'tr_11N', '+', 'tr_11O', '+', 'tr_11P'] },
                    'tr_11R': { 'formula': ['tr_11G', '+', 'tr_11J1'] },
                    'tr_12cA': { 'formula': ['tr_12bA', '-', 'tr_12A', '-', 'tr_12aA'] },
            ...
            $timeout($scope.initFormulas, 200);

            $scope.doCalculationForFieldsPerCountry = function (gasIndex, fields, countryIndex, fieldCountries, calculateDependencies) {
                //default value for calculating dependencies is true, for cases where recursion wont end, false should be set
                calculateDependencies = typeof calculateDependencies !== "undefined" ? calculateDependencies : true;
                ...
                for (var i = 0; i < fields.length; i++) {
                    var destinationObject = fields[i];
                    var formula = $scope.formulasForRows[destinationObject];
                    $scope.doCalculationForGasPerCountry(gasIndex, destinationObject, formula, countryIndex, fieldCountries);
                    if (calculateDependencies && angular.isDefined(formula.dependents)) {
                        var dependents = angular.isArray(formula.dependents) ? formula.dependents : [formula.dependents];
                        for (var j = 0; j < dependents.length; j++) {
                            $scope.doCalculationForFieldsPerCountry(gasIndex, dependents[j], countryIndex, fieldCountries);
                        }
                    }
                }
            }; // end of function doCalculationForFieldsPerCountry

            // Function to calculate a formula
            $scope.doCalculationForGasPerCountry = function (gasIndex, destinationRow, formulaDefinition, countryIndex, fieldCountries) {
                var formula = formulaDefinition.formula;
                var result = $scope.getValueForReportedGasAmountFromPerCountry(gasIndex, formula[0], countryIndex);

                if (formula.length > 2) {
                    //it is more than just assignment, so calculate value
                    var b = $scope.getValueForReportedGasAmountFromPerCountry(gasIndex, formula[2], countryIndex);
                    result = $scope.gasCalculationOperators[formula[1]](result, b);

                    for (var i = 3; i < formula.length; i += 2) {
                        b = $scope.getValueForReportedGasAmountFromPerCountry(gasIndex, formula[i + 1], countryIndex);
                ...
                var countries = $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp[fieldCountries].Country;

                var destinationObject = $scope.getGasElementFor(gasIndex, destinationRow);
                if (destinationObject && Array.isArray(destinationObject.CountrySpecific.Country)) {
                    destinationObject.CountrySpecific.Country[countryIndex] = {};
                    destinationObject.CountrySpecific.Country[countryIndex].Amount = result;
                    destinationObject.CountrySpecific.Country[countryIndex].CountryId = countries[countryIndex].CountryId;
                    if (destinationRow == "tr_01A_fs2") {
                        destinationObject.totalAmountForRow = result;
                    }
                } else {
                    destinationObject.CountrySpecific.Country = [];
                    destinationObject.CountrySpecific.Country[countryIndex] = {};
                    destinationObject.CountrySpecific.Country[countryIndex].Amount = result;
                    destinationObject.CountrySpecific.Country[countryIndex].CountryId = countries[countryIndex].CountryId;
                    if (destinationRow == "tr_01A_fs2") {
            ...
            }; // end of function doCalculationForGasPerCountry
            ...
            $scope.calculateTradingPartnerTotalAmountInteger = function(tradingPartnerElement) {
                ...
                $scope.check4MFieldQuotaNilReport(); // calculate if NIL report tick-box has to be desactivated, when 9A value has changed
            ...
            $scope.calculateTradingPartnerSum = function(tradingPartnerElement) {
                ...
                for (var i = 0; i < tradingPartnerElement.TradePartner.length; i++) {
                    if (tradingPartnerElement.TradePartner[i]) {
            ...
            $scope.isPreblended = function(gasOrComponent){
                return isPreblendedPolyols(gasOrComponent)
            };
            ...
            $scope.doCalculationTotalForRow = function(form, gasRow, calculations) {
                ...
                var rowsWithCountrySpecificReporting = ['tr_01A_fs', 'tr_01A_fs1', 'tr_01A_fs2', 'tr_02A', 'tr_02App', 'tr_02C', 'tr_02D', 'tr_02E','tr_03A','tr_03App','tr_03G','tr_03H','tr_03I'];
                ...
                // For the given row, if it belongs to the countryReporting rows, for all gases, get the gas value for the row, for all countries, and add it all

                for (var i = 0; i < sourceGases.length; i++) {
                    //If row is CountrySpecific, we need to get the Amount for all Countries of the Row, if the gas is HFC, if not, normal Amount
                    // will be fetched.

                    var gas = {};
                    gas.Id = sourceGases[i].GasCode;
                    sourceGases[i][gasRow].totalAmountForRow = "0";
                    if ((rowsWithCountrySpecificReporting.indexOf(gasRow) !== -1) && $scope.containsHFC($scope.get_gas_by_id(gas.Id))) {
                        //Get for each COuntrySpecific, the Amount
                        console.log("contains HFC");
                        gas.Amount = $scope.getValueForCountrySpecificReportedGasAmount(sourceGases[i][gasRow]);
                    } else {
                        gas.Amount = $scope.getValueForReportedGasAmount(sourceGases[i][gasRow]);
                    }
                    sourceGases[i][gasRow].totalAmountForRow = parseFloat(gas.Amount).toFixed(3);
                    inputArray.push(gas);
                }
            ...
            // Calculates sum for sheet 2 calculated fields, it is not done on the fly.
            $scope.calculateCo2EqForSheet2 = function () {
                var calcs = [
                   
                    ['tr_5C_exempted_CO2e', 'F2_S5_exempted_HFCs', 'tr_05C']
                ];
                ...
                for (var j = 0; j < calcs.length; j++) {
                    ...
                    for (var i = 0; i < sourceGases.length; i++) {
                        ...
                        gas.Amount = $scope.getValueForReportedGasAmount(sourceGases[i][gasRow]);
                        inputArray.push(gas);
                        //if ($scope.instance.FGasesReporting.F2_S5_exempted_HFCs.Gas[i].tr_5C_exempted_CO2e) {
                       //     $scope.instance.FGasesReporting.F2_S5_exempted_HFCs.Gas[i].tr_5C_exempted_CO2e.Amount = $scope.calculateSumAllGasesCO2Eq(inputArray);
                      //  }
                       // inputArray = [];
                    }
                    if ($scope.instance.FGasesReporting.F4_S9_IssuedAuthQuata[destination]) {
                        //     $scope.instance.FGasesReporting.F2_S5_exempted_HFCs.Gas[i].tr_5C_exempted_CO2e.Amount = $scope.calculateSumAllGasesCO2Eq(inputArray);
            ...
            $scope.calculateCo2EqForSheet4 = function() {
                ...
                for (var j = 0; j < calcs.length; j++) {
                    ...
                    var sourceGases = $scope.instance.FGasesReporting[form].Gas;
                    for (var i = 0; i < sourceGases.length; i++) {
                        var gasCode = sourceGases[i].GasCode;
                        var amount = $scope.getValueForReportedGasAmount(sourceGases[i][gasRow]);

                        var gasMetadata = arrayUtil.selectSingle($scope.instance.FGasesReporting.ReportedGases, function (reportedGas) {
                            return reportedGas.GasId === gasCode;
                        });

                        if (gasMetadata && $scope.containsHFC(gasMetadata)) {
                            inputArray.push({
                                Id: gasCode,
                                Amount: amount
                            });
            ...
            $scope.calculateSheet6Totals = function () {
                for (var i = 0; i < $scope.instance.FGasesReporting.ReportedGases.length; i++) {
                    var reportedGas = $scope.instance.FGasesReporting.ReportedGases[i];
                    if (viewModel.sheet6.section8._isHfcAndMixtures(reportedGas)) {
                        $scope.doCalculationForFields(i, ['tr_8D'], false);
                    } else {
                        $scope.doCalculationForFields(i, ['tr_8A', 'tr_8A1', 'tr_8A2', 'tr_8Aa', 'tr_8Ba', 'tr_8Ba1', 'tr_8Ba2', 'tr_8Baa', 'tr_8Bb', 'tr_8Bb1', 'tr_8Bb2', 'tr_8Bba', 'tr_8C', 'tr_8C1', 'tr_8C2', 'tr_8Ca', 'tr_8D', 'tr_8Da'], true);
                    }
                    
                }
            };

            $scope.sheet6CheckTransaction = function (transaction, transToEmptyArray) {
                if ($scope.instance.FGasesReporting.F6_FUDest.UISelectedTransactions[transaction] == false) {
                    for (var i = 0; i < $scope.instance.FGasesReporting.F6_FUDest.Gas.length; i++) {
                        var reportedGas = $scope.instance.FGasesReporting.F6_FUDest.Gas[i];
                        if (reportedGas[transaction].Amount != null && reportedGas[transaction].Amount > 0) {
                            var testDelete = confirm("The selected transaction contains values. Unchecking will delete the values too. Continue?");
                            if (!testDelete) {
                                $scope.instance.FGasesReporting.F6_FUDest.UISelectedTransactions[transaction] = true;
                            }
                        }
                    }
                }
                ...
                if ($scope.instance.FGasesReporting.F6_FUDest.UISelectedTransactions[transaction] == false) {
                    for (var i = 0; i < $scope.instance.FGasesReporting.F6_FUDest.Gas.length; i++) {
                        var reportedGas = $scope.instance.FGasesReporting.F6_FUDest.Gas[i];
                        if (reportedGas[transaction].Amount != null) {
                            reportedGas[transaction].Amount = 0;
                            if (reportedGas[transaction].Comment != undefined && reportedGas[transaction].Comment != "" && reportedGas[transaction].Comment != null) {
                                reportedGas[transaction].Comment = "";
                            }
                        }
                        if (transToEmptyArray) {
                            for (var j = 0; j < transToEmptyArray.length; j++) {
                                var transToEmpty = reportedGas[transToEmptyArray[j]];
                                if (transToEmpty.Amount != null) {
                                    transToEmpty.Amount = 0;
                                }
                            }
                        }
            ...
            $scope.form7transactions = [
                'tr_11A1a1', 'tr_11A1a2', 'tr_11A1a3', 'tr_11A1a4', 'tr_11A1b1', 'tr_11A1b2', 'tr_11A1b3', 'tr_11A1b4', 'tr_11A1c1', 'tr_11A1c2', 'tr_11A1c3', 'tr_11A1c4',
            ...
            $scope.confirmTransactions_section8 = function () {
                $scope.instance.FGasesReporting.F6_FUDest.transactionsConfirmed = true;
            };

            $scope.unConfirmTransactions_section8 = function () {
                $scope.instance.FGasesReporting.F6_FUDest.transactionsConfirmed = false;
            };

            // All the ranges are in kg, not tonnes!
            $scope.form7specificRanges = {
                'tr_11A1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 500 },
                'tr_11A1a': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 500 },
                'tr_11A1a1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 4 },
                'tr_11A1a2': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 4 }, 
                'tr_11A1a3': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 4 }, 
                'tr_11A1a4': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 2.5 }, 
                'tr_11A1b': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 15 }, 
                'tr_11A1b1': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 15 }, 
                'tr_11A1b2': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 15 }, 
                'tr_11A1b3': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 15 }, 
                'tr_11A1b4': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 15 }, 
                'tr_11A1c': { 'Outside': false, 'QCCode': '2300', 'lower': 7, 'upper': 500 },
                'tr_11A1c1': { 'Outside': false, 'QCCode': '2300', 'lower': 7, 'upper': 500 },
                'tr_11A1c2': { 'Outside': false, 'QCCode': '2300', 'lower': 7, 'upper': 500 },
                'tr_11A1c3': { 'Outside': false, 'QCCode': '2300', 'lower': 7, 'upper': 500 }, 
                'tr_11A1c4': { 'Outside': false, 'QCCode': '2300', 'lower': 7, 'upper': 500 }, 
                'tr_11A2': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 500 },

                'tr_11A2a': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 }, 
                'tr_11A2a1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 }, 
                'tr_11A2a1i': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 }, 
                'tr_11A2a1ii': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 }, 
                'tr_11A2a1iii': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 }, 
                'tr_11A2a2': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 }, 
                'tr_11A2a2i': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 }, 
                'tr_11A2a2ii': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 }, 
                'tr_11A2a2iii': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 },
                'tr_11A2a3': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 },
                'tr_11A2a3i': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 },
                'tr_11A2a3ii': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 },
                'tr_11A2a3iii': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 },

                'tr_11A2b': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 },
                'tr_11A2b1': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 100 }, 
                'tr_11A2b1i': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 100 }, 
                'tr_11A2b1ii': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 100 }, 
                'tr_11A2b1iii': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 100 },

                'tr_11A2b2': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 },
                'tr_11A2b2i': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 }, 
                'tr_11A2b2ii': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 },
                'tr_11A2b2iii': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 },

                'tr_11A2b3': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 }, 
                'tr_11A2b3i': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 },
                'tr_11A2b3ii': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 },  
                'tr_11A2b3iii': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 500 },  

                'tr_11B1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 1 },
                'tr_11B2': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 1000 },
                'tr_11B3': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 1000 },
                'tr_11B4': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 1000 },
                'tr_11B5': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 1000 },

                'tr_11C1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 },
                'tr_11C1a': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 },
                'tr_11C1b': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 6 },

                'tr_11C2': { 'Outside': false, 'QCCode': '2300', 'lower': 1.5, 'upper': 1000 },
                'tr_11C2a': { 'Outside': false, 'QCCode': '2300', 'lower': 1.5, 'upper': 1000 },
                'tr_11C2b': { 'Outside': false, 'QCCode': '2300', 'lower': 1.5, 'upper': 1000 },

                'tr_11D': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 1000 },

                'tr_11E1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.04, 'upper': 13 },
                'tr_11E2': { 'Outside': false, 'QCCode': '2300', 'lower': 0.025, 'upper': 6 },
                'tr_11E3': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 50 },
                'tr_11E4': { 'Outside': false, 'QCCode': '2300', 'lower': 0.02, 'upper': 9 },

                'tr_11F1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 1.5 },
                'tr_11F2': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 20 },
                'tr_11F3': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 1.5 },
                'tr_11F4': { 'Outside': false, 'QCCode': '2300', 'lower': 0.03, 'upper': 2 },
                'tr_11F5': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 2.5 },
                'tr_11F6': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 35 },
                'tr_11F7': { 'Outside': false, 'QCCode': '2300', 'lower': 0.3, 'upper': 50 },
                'tr_11F8': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 20 },
                'tr_11F9': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 50 },

                'tr_11H1': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 50 },
                'tr_11H2': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 10 },
                'tr_11H3': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 10 },
                'tr_11H4_m3': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 10 },
                'tr_11H4_pieces': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 10 },
                'tr_11H4_tonnes': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 50 },

                'tr_11I': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 50 },
                'tr_11J1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.007, 'upper': 0.02 },
                'tr_11J2': { 'Outside': false, 'QCCode': '2300', 'lower': 0.007, 'upper': 1 },

                'tr_11K': { 'Outside': false, 'QCCode': '2300', 'lower': 0.01, 'upper': 0.5 },

                'tr_11L1_m3': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 100 },
                'tr_11L1_pieces': { 'Outside': false, 'QCCode': '2300', 'lower': 0.01, 'upper': 50 },
                'tr_11L1_tonnes': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 1000 },
                'tr_11L2': { 'Outside': false, 'QCCode': '2300', 'lower': 0.01, 'upper': 50 },
                'tr_11L3_m3': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 100 },
                'tr_11L3_pieces': { 'Outside': false, 'QCCode': '2300', 'lower': 0.01, 'upper': 50 },
                'tr_11L3_tonnes': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 1000 },

                'tr_11M1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 5 },
                'tr_11M2': { 'Outside': false, 'QCCode': '2300', 'lower': 2, 'upper': 8 },
                'tr_11M3': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 105 },
                'tr_11M4': { 'Outside': false, 'QCCode': '2300', 'lower': 50, 'upper': 1500 },
                'tr_11M5': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 1500 },

                'tr_11N': { 'Outside': false, 'QCCode': '2300', 'lower': 0.02, 'upper': 50 }, // had to swap min, max

                'tr_11O1': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 1 },
                'tr_11O2': { 'Outside': false, 'QCCode': '2300', 'lower': 3, 'upper': 9 },
                'tr_11O3': { 'Outside': false, 'QCCode': '2300', 'lower': 5, 'upper': 18000 },
                'tr_11O4': { 'Outside': false, 'QCCode': '2300', 'lower': 0.2, 'upper': 5000 },

                'tr_11P_tonnes': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 1000 },
                'tr_11P_pieces': { 'Outside': false, 'QCCode': '2300', 'lower': 0.01, 'upper': 50 },
                'tr_11P_m3': { 'Outside': false, 'QCCode': '2300', 'lower': 10, 'upper': 100 }
            };
            ...
            $scope.form7checkS2Range = function () {
                ...
                for (var i = 0; i < $scope.form7specificRangesAutomatic.length; i++) {
                    ...
                    if (tr != "tr_11H4" && tr != "tr_11P" && tr != "tr_11L1" && tr != "tr_11L3") {
                        $scope.testForm7TransactionS2Range(tr, tr)
                    }
                }

                // Testing for tr_11L1 different options
                // We have to reinitialize all options as the selection might have changed
                tr = '';
                var tr11L1 = '';
                $scope.form7specificRanges["tr_11L1_tonnes"].Outside = false;
                $scope.form7specificRanges["tr_11L1_pieces"].Outside = false;
                $scope.form7specificRanges["tr_11L1_m3"].Outside = false;

                switch ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L1_Unit) {
                    case 'cubicmetres':
                        tr11L1 = "tr_11L1_m3";
                        break;
                    case 'metrictonnes':
                        tr11L1 = "tr_11L1_tonnes";
                        break;
                    case 'pieces':
                        tr11L1 = "tr_11L1_pieces";
                        break;
                }
                $scope.testForm7TransactionS2Range("tr_11L1", tr11L1);

                // Testing for tr_11L3 different options
                // We have to reinitialize all options as the selection might have changed
                tr = '';
                var tr11L3 = '';
                $scope.form7specificRanges["tr_11L3_tonnes"].Outside = false;
                $scope.form7specificRanges["tr_11L3_pieces"].Outside = false;
                $scope.form7specificRanges["tr_11L3_m3"].Outside = false;

                switch ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L3_Unit) {
                    case 'cubicmetres':
                        tr11L3 = "tr_11L3_m3";
                        break;
                    case 'metrictonnes':
                        tr11L3 = "tr_11L3_tonnes";
                        break;
                    case 'pieces':
                        tr11L3 = "tr_11L3_pieces";
                        break;
                }
                $scope.testForm7TransactionS2Range("tr_11L3", tr11L3);
                ...
                var tr11H = '';
                // We have to reinitialize all options as the selection might have changed
                $scope.form7specificRanges["tr_11H4_m3"].Outside = false;
                $scope.form7specificRanges["tr_11H4_tonnes"].Outside = false;
                $scope.form7specificRanges["tr_11H4_pieces"].Outside = false;
                switch ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11H4_Unit) {
                    case 'cubicmetres':
                        tr11H = "tr_11H4_m3";
                        break;
                    case 'metrictonnes':
                        tr11H = "tr_11H4_tonnes";
                        break;
                    case 'pieces':
                        tr11H = "tr_11H4_pieces";
                        break;
                    default:
                        tr11H = null;
                        break
                }
                $scope.testForm7TransactionS2Range("tr_11H4", tr11H);
            };
            ...
            $scope.testForm7TransactionS2Range = function(sourceTransaction, validationTransaction) {
                if (validationTransaction != null && validationTransaction != '' &&
                    ...
                    if (validationTransaction == "tr_11H4" || validationTransaction == "tr_11P" || validationTransaction == "tr_11L1" || validationTransaction == "tr_11L3") {
            ...
            $scope.form7CheckTransaction = function(transaction) {
                ...
                if ($scope.instance.FGasesReporting.F7_s11EquImportTable.UISelectedTransactions[transaction] == false || $scope.instance.FGasesReporting.F7_s11EquImportTable.UISelectedTransactions[transaction] == null) {
                    $scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1[transaction].Amount = 0;
                    ...
                    if (transaction == 'tr_11H4') {
                        $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11H4_Unit = '';
                    }

                    if (transaction == 'tr_11L1') {
                        $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L1_Unit = '';
                    }

                    if (transaction == 'tr_11L3') {
                        $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L3_Unit = '';
                    }
            ...
            $scope.filterNonFlourGases = function (gas) {
                var isNonFlourGas = false;
                if (gas.GasGroupId == 6 || gas.GasGroupId == 12) {
                    isNonFlourGas = true;
                } else {
                    if (gas.BlendComponents && gas.BlendComponents.Component && gas.BlendComponents.Component.length > 0) {
                        /*gas.BlendComponents.Component.forEach(function (component) { // mixture gases or non-fluorated gases
                            if (component.GasGroupId === 6 || component.GasGroupId === 12 || $scope.isNonOnlyFluorinatedGases(gas)) {
                                isNonFlourGas = true;
                            }
                        });*/
                        var hasAllNonFluorComp = gas.BlendComponents.Component.every(component => (component.GasGroupId === 6 || component.GasGroupId === 12 || component.IsNonFGas === true)); // if all components are non-fluorinated
                        if (hasAllNonFluorComp || $scope.isNonOnlyFluorinatedGases(gas)) {
                            isNonFlourGas = true;
                        }
                    }
                }
                return !isNonFlourGas; 
            };

            $scope.isNonOnlyFluorinatedGases = function (gas) {
                if (gas.IsCustomComposition) {
                    return gas.BlendComponents.Component.every(component => component.IsNonFGas === true); // if all components pass this condition
                } else {
                    return false;
                }
            ...
            $scope.calculateForm7Totals = function () {
                ...
                if ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11H4_Unit == 'pieces' &&
                    $scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11H4.Amount != null &&
                    $scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11H4.Amount != '') {
                    $scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11H4.Amount = Math.round($scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11H4.Amount);
                }
                ...
                for (var j = 0; j < $scope.form7transactions.length; j++) {
                    ...
                    for (var i = 0; i < $scope.instance.FGasesReporting.ReportedGases.length; i++) {
                        ...
                        $scope.doCalculationForFields(i, ['tr_11A', 'tr_11A1', 'tr_11A1a', 'tr_11A1b', 'tr_11A1c', 'tr_11A2', 'tr_11A2a', 'tr_11A2a1', 'tr_11A2a2', 'tr_11A2a3', 'tr_11A2b', 'tr_11A2b1', 'tr_11A2b2', 'tr_11A2b3', 'tr_11B', 'tr_11C', 'tr_11C1', 'tr_11C2', 'tr_11E', 'tr_11F', 'tr_11G', 'tr_11H', 'tr_11J', 'tr_11L', 'tr_11M', 'tr_11O', 'tr_11Q', 'tr_11R'], false);
                ...
                $scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11A.Amount =
                    $scope.getImpEqValue("tr_11A1a1") +
                    $scope.getImpEqValue("tr_11A1a2") +
                    $scope.getImpEqValue("tr_11A1a3") +
                    $scope.getImpEqValue("tr_11A1a4") +
                    $scope.getImpEqValue("tr_11A1b1") +
                    $scope.getImpEqValue("tr_11A1b2") +
                    $scope.getImpEqValue("tr_11A1b3") +
                    $scope.getImpEqValue("tr_11A1b4") +
                    $scope.getImpEqValue("tr_11A1c1") +
                    $scope.getImpEqValue("tr_11A1c2") +
                    $scope.getImpEqValue("tr_11A1c3") +
                    $scope.getImpEqValue("tr_11A1c4") +
                    $scope.getImpEqValue("tr_11A2a1i") +
                    $scope.getImpEqValue("tr_11A2a1ii") +
                    $scope.getImpEqValue("tr_11A2a1iii") +
                    $scope.getImpEqValue("tr_11A2a2i") +
                    $scope.getImpEqValue("tr_11A2a2ii") +
                    $scope.getImpEqValue("tr_11A2a2iii") +
                    $scope.getImpEqValue("tr_11A2a3i") +
                    $scope.getImpEqValue("tr_11A2a3ii") +
                    $scope.getImpEqValue("tr_11A2a3iii") +
                    $scope.getImpEqValue("tr_11A2b1i") +
                    $scope.getImpEqValue("tr_11A2b1ii") +
                    $scope.getImpEqValue("tr_11A2b1iii") +
                    $scope.getImpEqValue("tr_11A2b2i") +
                    $scope.getImpEqValue("tr_11A2b2ii") +
                    $scope.getImpEqValue("tr_11A2b2iii") +
                    $scope.getImpEqValue("tr_11A2b3i") +
                    $scope.getImpEqValue("tr_11A2b3ii") +
                    $scope.getImpEqValue("tr_11A2b3iii");

                $scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11B.Amount =
                    $scope.getImpEqValue("tr_11B1") +
                    $scope.getImpEqValue("tr_11B2") +
                    $scope.getImpEqValue("tr_11B3") +
                    $scope.getImpEqValue("tr_11B4") +
                    $scope.getImpEqValue("tr_11B5");
                $scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11C.Amount =
                    $scope.getImpEqValue("tr_11C1a") +
                    $scope.getImpEqValue("tr_11C1b") +
                    $scope.getImpEqValue("tr_11C2a") +
                    $scope.getImpEqValue("tr_11C2b");
                $scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11E.Amount =
                    $scope.getImpEqValue("tr_11E1") +
                    $scope.getImpEqValue("tr_11E2") +
                    $scope.getImpEqValue("tr_11E3") +
                    $scope.getImpEqValue("tr_11E4");

                $scope.instance.FGasesReporting.F7_s11EquImportTable.AmountOfImportedEquipment.tr_11F.Amount =
                    $scope.getImpEqValue("tr_11F1") +
                    $scope.getImpEqValue("tr_11F2") +
                    $scope.getImpEqValue("tr_11F3") +
                    $scope.getImpEqValue("tr_11F4") +
                    $scope.getImpEqValue("tr_11F5") +
                    $scope.getImpEqValue("tr_11F6") +
                    $scope.getImpEqValue("tr_11F7") +
                    $scope.getImpEqValue("tr_11F8") +
                    $scope.getImpEqValue("tr_11F9");
            ...
            $scope.QC_1056_1057_transactions = [
                ...
                'tr_11A2b1i', 'tr_11A2b1ii', 'tr_11A2b1iii', 'tr_11A2b2i', 'tr_11A2b2ii', 'tr_11A2b2iii', 'tr_11A2b3i', 'tr_11A2b3ii', 'tr_11A2b3iii',
                'tr_11B1', 'tr_11B2', 'tr_11B3', 'tr_11B4', 'tr_11B5',
                'tr_11C1a', 'tr_11C1b', 'tr_11C2a', 'tr_11C2b', 'tr_11D', 'tr_11E1', 'tr_11E2', 'tr_11E3', 'tr_11E4',
                'tr_11F1', 'tr_11F2', 'tr_11F3', 'tr_11F4', 'tr_11F5', 'tr_11F6', 'tr_11F7', 'tr_11F8', 'tr_11F9', 'tr_11J1'
            ];

            $scope.QC_1058_transactions = [
                'tr_11H1', 'tr_11H2', 'tr_11H3', 'tr_11H4', 'tr_11I', 'tr_11J2', 'tr_11K', 'tr_11L1', 'tr_11L2', 'tr_11L3', 'tr_11M1', 'tr_11M2', 'tr_11M3', 'tr_11M4', 'tr_11M5', 'tr_11N',
                'tr_11O1', 'tr_11O2', 'tr_11O3', 'tr_11O4', 'tr_11P'
            ];


            $scope.calculateQC_1056_1057_1058 = function() {
                // Calculating QC rules 1056, 1057 and 1058
                $scope.qc1056fail = [];
                $scope.qc1057fail = [];
                $scope.qc1058fail = [];
            ...
            $scope.valSubCat = ['general', 'activities', 'gases', 'sheet1', 'sheet2', 'sheet2a', 'sheet3', 'sheet4', 'sheet6a', 'sheet6b', 'form7', 'sheet8', 'sheet9'];
            $scope.errors = {};
            ...
            $scope.validateBySubCat = function (subCat) {
                switch (subCat) {
                    ...
                    case 'sheet4':
                        ...
                        break;
                    case 'sheet6a':
                        $scope.validateSheet6a();
                        break;
                    case 'sheet6b':
                        $scope.validateSheet6b();
                        break;
                    case 'form7':
                        $scope.validateForm7();
                        break;
            ...
            $scope.sheet1ValidationRules = [{
                ...
                'rules': [{
                    'condition':
                        '$scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01D) <= ($scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01Ab) + $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04C))' +
                        ' && (' +
                        '!$scope.instance.FGasesReporting.GeneralReportData.Activities["D"] || ' +
                        '$scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01D) <= ($scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01Ab) + $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_8E))' +
                        ')',
                    'qccode': 2099
                }]
                },
                /*{
                    'preCondition': '($scope.instance.FGasesReporting.GeneralReportData.Activities["I"] || $scope.instance.FGasesReporting.GeneralReportData.Activities["P"]) && $scope.instance.FGasesReporting.GeneralReportData.Activities["FU"] && viewModel.sheet6.section7._isHfc23(reportedGas)',
                    'transaction': { 'id': 'tr_01A_fs', 'label': '01C_a' },
                    'rules': [{ 'condition': '$scope.getValueForCountrySpecificReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01A_fs) <= ($scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_07Aa.Amount)', 'qccode': 2105 }]
                },*/
                {
                ...
                },
                {
                    ...
                    'rules': [{
                        'condition': '$scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02B) <= (' +
                            '($scope.containsHFC(reportedGas) ? $scope.getValueForCountrySpecificReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02A) ' +
                            ': $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02A)) ' +
                            '+ $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02G) ' +
                            '+ $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04C))',
                        'qccode': 2098
                    }]
                },
                ...
                },
                {
                    ...
                    'transaction': { 'id': 'tr_04A', 'label': '04A', 'notNull': true },
                    'rules': [{ 'condition': '$scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04A) >= ($scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04Aa) + $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_8E))', 'qccode': 2020 }]
                },
                {
                ...
                {
                    'preCondition': '($scope.instance.FGasesReporting.GeneralReportData.Activities["I"] || $scope.instance.FGasesReporting.GeneralReportData.Activities["P"] || !$scope.containsHFC(reportedGas)) && $scope.instance.FGasesReporting.GeneralReportData.Activities["D"]',
                    'transaction': { 'id': 'tr_04F', 'label': '04F', 'notNull': true },
                    'rules': [{ 'condition': '$scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04F) >= ($scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04Fa) + $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_8F))', 'qccode': 2023 }]
                },
                {
                    'preCondition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["P"] || $scope.instance.FGasesReporting.GeneralReportData.Activities["I"]',
                ...
                {
                    'preCondition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["E"]',
                    'transaction': { 'id': 'tr_03B', 'label': '03B' },
                    'rules': [{
                        'condition': 'viewModel.getReportedGases().length > 0 && ' +
                            '($scope.containsHFC(reportedGas) ? ' +
                            '$scope.getValueForCountrySpecificReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03A) ' +
                            ': $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03A)) ' +
                            '>= $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03B.Amount',
                        'gasShow': true,
                        'qccode': 2019
                    }]
                }
            ...
            $scope.validateSheet1 = function() {
                ...
                //QC rules 2002, 2003, 2004, 2005, 2006, 2014, 2109
                var miniValidationRules = [{
                        ...
                        'rules': [{ 'condition': 'viewModel.getReportedGases().length > 0 && !reportedGas.IsBlend && !$scope.isUnspecifiedMix(reportedGas) && $scope.containsHFC(reportedGas) && ($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01A.Amount > 0 || $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01D.Amount > 0 )', 'qccode': 2002 }]
                    },
                    {
                        'preCondition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["P-other"]',
                        'transaction': { 'id': 'tr_01A', 'label': '01A' },
                        'rules': [{ 'condition': 'viewModel.getReportedGases().length > 0 && !reportedGas.IsBlend && !$scope.isUnspecifiedMix(reportedGas) && !$scope.containsHFC(reportedGas) && ($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01A.Amount > 0 || $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01D.Amount > 0 )', 'qccode': 2003 }]
                    },
                    {
                    ...
                    },
                    {
                        'preCondition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["E"]',
                        'transaction': { 'id': 'tr_03A', 'label': '03A' },
                        'rules': [{ 'condition': 'viewModel.getReportedGases().length > 0 && ($scope.getValueForCountrySpecificReportedGasAmount($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03A) > 0 || $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03A.Amount > 0)', 'qccode': 2006 }]
                    },
                    {
                        'preCondition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["RC"]',
                        'transaction': { 'id': 'tr_04Aa', 'label': '04Aa' },
                        'rules': [{ 'condition': 'viewModel.getReportedGases().length > 0 && ($scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04Aa.Amount > 0 || $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04Fa.Amount > 0 || $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_04K.Amount > 0 )', 'qccode': 2109 }]
                    }
                ];
            ...
            $scope.hasRequiredQuantitiesForQcs_2004_2005 = function(gasIndex, qcCode) {
                ...
                var transactions = ['tr_02A', 'tr_02G', 'tr_02H', 'tr_02I', 'tr_04A', 'tr_04B', 'tr_04C', 'tr_04F'];

                if (qcCode === 2004) {
                    return arrayUtil.contains(transactions, function (transaction) {
                        var amount = 0;
                        if (transaction === 'tr_02A') {
                            amount = gasQuantities[transaction].totalAmountForRow;

                        } else if (transaction === 'tr_02H') {
                            amount = gasQuantities[transaction].SumOfPartnerAmounts;
                        } else {
                            amount = gasQuantities[transaction].Amount;
                        }
            ...
            // Function to do validation on sheet2a. This function heavily depend on sheet2aValidationRules variable.
            // Local variable names are important, some of them are used in eval expressions. See also: $scope.validateSheet
            $scope.validateSheet2a = function () {
                //clear previous error messages
                var sheetId = 'sheet2a'; //sheet2a
                $scope.errors[sheetId] = [];
                //re calculate necessary values
                $scope.reCalculateSheet2a();
                arrayUtil.pushMany($scope.errors[sheetId], sheet2aValidator.validate(viewModel));
                //QC rules 2012 and 2013
                var miniValidationRules = [{
                    'preCondition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["RQ"]',
                    'transaction': { 'id': 'tr_05aD', 'label': '5aD' },
                    'rules': [{ 'condition': 'viewModel.getReportedGases().length > 0 && $scope.containsHFC(reportedGas) && ($scope.instance.FGasesReporting.F2a_S5a_exempted_HFCs.Gas[gasIndex].tr_05aD.Amount > 0 || $scope.instance.FGasesReporting.F2a_S5a_exempted_HFCs.Gas[gasIndex].tr_05aE.Amount > 0 )', 'qccode': 2012 }]
                },
                {
                    'preCondition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["RH"]',
                    'transaction': { 'id': 'tr_05aF', 'label': '5aF' },
                    'rules': [{ 'condition': 'viewModel.getReportedGases().length > 0 && $scope.containsHFC(reportedGas) && ($scope.instance.FGasesReporting.F2a_S5a_exempted_HFCs.Gas[gasIndex].tr_05aF.Amount > 0 )', 'qccode': 2013 }]
                }
            ];

            var sheet2aValidationRules = [];
            var filteredRules = [];
            ...
            for (var gasIndex = 0; gasIndex < reportedGases.length; gasIndex++) {
                ...
                arrayUtil.forEach($scope.getTransactionErrorsForGas(sheet2aValidationRules, gasIndex), function (e) {
            ...
            //end of qc checks 2012 and 2013
                //update messages
                $scope.updateValidationMessages(sheetId);
            }; // end of function validateSheet2a
            ...
            $scope.sheet3ValidationRules = [{
                ...
                'rules': [{ 'condition': '$scope.instance.FGasesReporting.F3A_S6A_IA_HFCs.Gas[gasIndex].tr_06X.Amount >= 0 && $scope.isTabVisible("sheet3") ', 'qccode': 2043 }]
            ...
            $scope.sheet6aValidationRules = [{
                'preCondition': '$scope.instance.FGasesReporting.GeneralReportData.Activities["FU"]',
                'transaction': { 'id': 'tr_07Aa', 'label': '07Aa' },
                'rules': [{ 'condition': '$scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_07A) >= $scope.getValueForReportedGasAmount($scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_07Aa)', 'qccode': 2104 }]
            }];

            $scope.validateSheet6a = function() {
                //re calculate necessary values
                $scope.reCalculateSheet6();
                var sheetId = 'sheet6a'; //sheet6a
                var formId = 'F6_FUDest';
                $scope.errors[sheetId] = [];

                $scope.validateSheet(formId, sheetId, $scope.sheet6aValidationRules, $scope.errors[sheetId]);
                ...
                arrayUtil.pushMany($scope.errors[sheetId], sheet6aValidator.validate(viewModel));
                var filteredRules = [];
                var reportedGases = $scope.instance.FGasesReporting.ReportedGases;
                //no need to check for precondition in each time for gas loop, so filter first and then continue
                for (var i = 0; i < miniValidationRules.length; i++) {
                ...
                //end of qc checks 2008
                $scope.updateValidationMessages(sheetId);
            };

            $scope.validateSheet6b = function () {
                //re calculate necessary values
                $scope.reCalculateSheet6();
                var sheetId = 'sheet6b'; //sheet6b
                var formId = 'F6_FUDest';
                $scope.errors[sheetId] = [];
                ...
                var miniValidationRules = [
                    {
                        ...
                        'transaction': { 'id': 'tr_8D', 'label': '8_D' },
                        'rules': [{
                            'condition': 'viewModel.getReportedGases().length > 0 && ($scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_8D.Amount > 0 || $scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_8E.Amount > 0 || $scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_8F.Amount > 0)',
                            'qccode': 2009
                        }]
                    }
                ];
                ...
                var sheet6ValidationRules = [];
                arrayUtil.pushMany($scope.errors[sheetId], sheet6bValidator.validate(viewModel));
                var filteredRules = [];
                var reportedGases = $scope.instance.FGasesReporting.ReportedGases;
                //no need to check for precondition in each time for gas loop, so filter first and then continue
                for (var i = 0; i < miniValidationRules.length; i++) {
                ...
                //end of qc checks 2009
                $scope.updateValidationMessages(sheetId);
            };
            $scope.validateSheet7 = function () {
                $scope.validateForm7();
            ...
            $scope.validateSheet = function(formId, sheetId, sheetRules, sheetErrors) {
                for (var i = 0; i < sheetRules.length; i++) {
                    ...
                    for (var gasIndex = 0; gasIndex < $scope.instance.FGasesReporting.ReportedGases.length; gasIndex++) {
                        ...
                        if (inputField == null || (inputField.Amount == null && inputField.SumOfPartnerAmounts == null && inputField.totalAmountForRow == null && !sheetRules[i].transaction.notNull)) {
                        ...
                        for (var j = 0; j < sheetRules[i].rules.length; j++) {
                            ...
                            if (!eval(rule.condition)) {
                                ...
                                if (rule.gasShow) {
                                    errorVar.message = $translate.instant('validation_messages.qc_2019.error_text', {
                                        gas: reportedGas.Name
                                    });
                                }
                                transactionErrors.errors.push(errorVar);
                            }
            ...
            $scope.validateForm7 = function() {
                ...
                for (var j = 0; j < $scope.form7transactions.length; j++) {
                    ...
                    if ((transaction == 'tr_11A1a4' ||
                        transaction == 'tr_11A1b4' ||
                        transaction == 'tr_11A1c4' ||
                        transaction == 'tr_11A2a1iii' ||
                        transaction == 'tr_11A2b1iii' ||
                        transaction == 'tr_11A2a2iii' ||
                        transaction == 'tr_11A2a3iii' ||
                        transaction == 'tr_11A2b2iii' ||
                        transaction == 'tr_11A2b3iii' ||
                        transaction == 'tr_11B5' ||
                        transaction == 'tr_11C1b' ||
                        transaction == 'tr_11C2b' ||
                        transaction == 'tr_11D' ||
                        transaction == 'tr_11E4' ||
                        transaction == 'tr_11F9') &&
                            ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == null ||
                            $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]].length < 0 ||
                            $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]].length == "") &&
                            $scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1[transaction].Amount > 0)
                    {
                    ...
                    if ((transaction == 'tr_11A1a4' ||
                        ...
                        ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] != null &&
                            ...
                            $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]].length != "") &&
                        $scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1[transaction].Amount > 0) {
                        $scope.pushFlag('form7', j, 2048, null);
                    }
                    ...
                    if (transaction == 'tr_11H4') {
                        if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11H4'].Amount > 0) {
                            if ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == null ||
                                $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == "") {
                                $scope.pushError('form7', j, 2087, null);
                            } else {
                                $scope.pushFlag('form7', j, 2087, null);
                            }
                            ...
                            if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11H4'].Amount > 0 &&
                                ...
                                $scope.validateForm7Transaction11H4(function (transaction, rangeData, isWarning) {
                                    if (isWarning) {
                    ...
                    } else if (transaction == 'tr_11L1') {
                        if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11L1'].Amount > 0) {
                            if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11L1'].Amount > 0 &&
                                ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L1_Unit == null ||
                                    $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L1_Unit == '')) {
                                $scope.pushError('form7', j, 2050, null);
                            } else {
                                $scope.validateForm7Transaction11L1(function (transaction, rangeData, isWarning) {
                                    if (isWarning) {
                                        $scope.pushWarning('form7', j, $scope.form7specificRanges[transaction].QCCode, $translate.instant('validation_messages.qc_2300_warning.error_text', {
                                            transaction: $scope.getForm7TransactionCode(transaction),
                                            min: rangeData.min,
                    ...
                    } else if (transaction == 'tr_11L3') {
                        if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11L3'].Amount > 0) {
                            if ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == null ||
                                $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == "") {
                                $scope.pushError('form7', j, 2090, $translate.instant('validation_messages.qc_2090.error_text_11_L3'));
                            } else {
                                $scope.pushFlag('form7', j, 2090, null);
                            }

                            if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11L3'].Amount > 0 &&
                                ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L3_Unit == null ||
                                    $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L3_Unit == '')) {
                                $scope.pushError('form7', j, 2050, null);
                            } else {
                                $scope.validateForm7Transaction11L3(function (transaction, rangeData, isWarning) {
                                    if (isWarning) {
                                        $scope.pushWarning('form7', j, $scope.form7specificRanges[transaction].QCCode, $translate.instant('validation_messages.qc_2300_warning.error_text', {
                                            transaction: $scope.getForm7TransactionCode(transaction),
                                            min: rangeData.min,
                        ...
                        if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11P'].Amount > 0) {
                            if ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == null ||
                                ...
                                $scope.pushFlag('form7', j, 2079, null);
                            }

                            if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11P'].Amount > 0 && ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11P_Unit == null ||
                                $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11P_Unit == '')) {
                                $scope.pushError('form7', j, 2050, null);
                            } else {
                    ...
                    } else if (transaction == 'tr_11J2' || transaction == 'tr_11M5' || transaction == 'tr_11N' || transaction == 'tr_11O4') {
                        switch (transaction) {
                            case 'tr_11J2':
                                if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11J2'].Amount > 0) {
                                    if ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == null ||
                                        $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == "") {
                                        $scope.pushError('form7', j, 2090, $translate.instant('validation_messages.qc_2090.error_text_11_J2'));
                                    } else {
                                        $scope.pushFlag('form7', j, 2090, null);
                                    }
                                }
                                break;
                            case 'tr_11M5':
                                if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11M5'].Amount > 0) {
                                    if ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == null ||
                                        $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == "") {
                                        $scope.pushError('form7', j, 2090, $translate.instant('validation_messages.qc_2090.error_text_11_M5'));
                                    } else {
                                        $scope.pushFlag('form7', j, 2090, null);
                                    }
                                }
                                break;
                            case 'tr_11N':
                                if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11N'].Amount > 0) {
                                    if ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == null ||
                                        $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == "") {
                                        $scope.pushError('form7', j, 2090, $translate.instant('validation_messages.qc_2090.error_text_11_N'));
                                    } else {
                                        $scope.pushFlag('form7', j, 2090, null);
                                    }
                                }
                                break;
                            case 'tr_11O4':
                                if ($scope.instance.FGasesReporting.F7_s11EquImportTable.SumOfAllGasesS1['tr_11O4'].Amount > 0) {
                                    if ($scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == null ||
                                        $scope.instance.FGasesReporting.F7_s11EquImportTable.Category[$scope.form7transactions[j]] == "") {
                                        $scope.pushError('form7', j, 2090, $translate.instant('validation_messages.qc_2090.error_text_11_O4'));
                                    } else {
                                        $scope.pushFlag('form7', j, 2090, null);
                                    }
                                }
                ...
                for (var i = 0; i < $scope.instance.FGasesReporting.ReportedGases.length; i++) {
                    if ($scope.instance.FGasesReporting.ReportedGases[i].GWP_AR4_HFC != null && $scope.instance.FGasesReporting.ReportedGases[i].GWP_AR4_HFC > 0 && viewModel.sheetActivities.isEq_I_RACHP_HFC()) {
                        ...
                        if ($scope.instance.FGasesReporting.F7_s11EquImportTable.Gas[i].tr_11J1.Amount != null && $scope.instance.FGasesReporting.F7_s11EquImportTable.Gas[i].tr_11J1.Amount > 0) {
                            sum11G_HFC += $scope.instance.FGasesReporting.F7_s11EquImportTable.Gas[i].tr_11J1.Amount;
                        }
                    }
                }
                // If there were HFC containing gases found, but their reported amount is 0, it's a QC 2010 validation mistake.
                if (viewModel.sheetActivities.isEq_I_RACHP_HFC() && (viewModel.getReportedGases().length === 0 || (viewModel.getReportedGases().length > 0 && countHFC_QC2010 === 0) || (sum11G_HFC == 0 && countHFC_QC2010 > 0))) {
                ...
                var sum11_HFC = 0;
                var countHFC_QC2011 = 0;

                var gases = $scope.instance.FGasesReporting.ReportedGases;

                var nonHFC_QC2011Transactions = ['tr_11G', 'tr_11H1', 'tr_11H2', 'tr_11H3', 'tr_11H4', 'tr_11I', 'tr_11J', 'tr_11K', 'tr_11L', 'tr_11M', 'tr_11N', 'tr_11O', 'tr_11P', 'tr_11Q'];
                ...
                // If there were HFC containing gases found, but their reported amount is 0, it's a QC 2010 validation mistake.
                if (viewModel.sheetActivities.isEq_I_other() &&
                    (gases.length === 0 ||
                    (sum11_NonHFC + sum11_HFC) === 0)
                ) {
            ...
            $scope.validateForm7Transaction11H4 = function (handler) {
                var tr11H = '';
                switch ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11H4_Unit) {
                    case 'cubicmetres':
                        tr11H = "tr_11H4_m3";
                ...
                if (tr11H.length > 0) {
                    if ($scope.form7specificRanges[tr11H].Outside === true) {
                        var rangeObject = $scope.getRange('tr_11H4', $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11H4_Unit);
                        if (($scope.instance.FGasesReporting.F7_s11EquImportTable.Comment['tr_11H4'] === null || $scope.instance.FGasesReporting.F7_s11EquImportTable.Comment['tr_11H4'].length < 2)) {
            ...
            $scope.validateForm7Transaction11L1 = function (handler) {
                var tr11L1 = '';
                switch ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L1_Unit) {
                    case 'cubicmetres':
                        tr11L1 = "tr_11L1_m3";
                ...
                if (tr11L1.length > 0) {
                    if ($scope.form7specificRanges[tr11L1].Outside === true) {
                        var rangeObject = $scope.getRange('tr_11L1', $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L1_Unit);
                        if (($scope.instance.FGasesReporting.F7_s11EquImportTable.Comment['tr_11L1'] === null || $scope.instance.FGasesReporting.F7_s11EquImportTable.Comment['tr_11L1'].length < 2)) {
                            handler(tr11L1, rangeObject, false); // error
                        } else {
                            handler(tr11L1, rangeObject, true); // warning
                        }
                    }
                }
            };
            $scope.validateForm7Transaction11L3 = function (handler) {
                var tr11L3 = '';
                switch ($scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L3_Unit) {
                    case 'cubicmetres':
                        tr11L3 = "tr_11L3_m3";
                ...
                if (tr11L3.length > 0) {
                    if ($scope.form7specificRanges[tr11L3].Outside === true) {
                        var rangeObject = $scope.getRange('tr_11L3', $scope.instance.FGasesReporting.F7_s11EquImportTable.TR_11L3_Unit);
                        if (($scope.instance.FGasesReporting.F7_s11EquImportTable.Comment['tr_11L3'] === null || $scope.instance.FGasesReporting.F7_s11EquImportTable.Comment['tr_11L3'].length < 2)) {
                            handler(tr11L3, rangeObject, false); // error
                        } else {
                            handler(tr11L3, rangeObject, true); // warning
                        }
                    }
                }
            };
            ...
            /*updated 2020
                {
                    ...
                    'gases': ['id-3', 'id-7', 'id-26', 'id-27', 'id-29', 'id-306']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    ...
                    'gases': ['id-2', 'id-3', 'id-5', 'id-7', 'id-9', 'id-14', 'id-16', 'id-19', 'id-21', 'id-26', 'id-27', 'id-46', 'id-48', 'id-96', 'id-229', 'id-301', 'id-302', 'id-303', 'id-306', 'id-504', 'id-507', 'id-510', 'id-512', 'id-514', 'id-520', 'id-522', 'id-523', 'id-530', 'id-541', 'id-543', 'id-545', 'id-551', 'id-553']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                ...
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11D01'],
                    'transactionLabels': ['11D01', '11D02', '11D03'],
                    'gases': ['id-2', 'id-3', 'id-7', 'id-26', 'id-27', 'id-28', 'id-29', 'id-46', 'id-96', 'id-147', 'id-230', 'id-345', 'id-500']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': [ 'tr_11D02'],
                    'transactionLabels': ['11D01', '11D02', '11D03'],
                    'gases': ['id-2', 'id-3', 'id-7', 'id-26', 'id-27', 'id-28', 'id-29', 'id-46', 'id-96', 'id-147', 'id-345']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11D03'],
                    'transactionLabels': ['11D01', '11D02', '11D03'],
                    'gases': ['id-2', 'id-3', 'id-7', 'id-26', 'id-27', 'id-28', 'id-29', 'id-46', 'id-96', 'id-345']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11E01', 'tr_11E02', 'tr_11E03'],
                    'transactionLabels': ['11E01', '11E02', '11E03'],
                    'gases': ['id-7', 'id-26', 'id-27', 'id-28']
                },               
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    ...
                    'gases': ['id-7', 'id-190', 'id-27', 'id-29', 'id-37']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                ...
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11N', 'tr_11O'],
                    'transactionLabels': ['11N','11O'],
                    'gases': ['id-1']
                },
                {
                ...
                },
                {
                    ...
                    'gases': ['id-2', 'id-3', 'id-5', 'id-7', 'id-9', 'id-16', 'id-26', 'id-27', 'id-28', 'id-29', 'id-37', 'id-38', 'id-39', 'id-42', 'id-43', 'id-44', 'id-45', 'id-46', 'id-52', 'id-89', 'id-91', 'id-137', 'id-146', 'id-147', 'id-190']
                },
                
                {
                    ...
                    'gases': ['id-7', 'id-10', 'id-16', 'id-146', 'id-147', 'id-192', 'id-193']
                },
                ...
                },
                {
                    ...
                    'gases': ['id-11', 'id-14', 'id-16', 'id-17', 'id-18', 'id-21', 'id-25', 'id-146']
                },
                {
                    'form': 'F3A_S6A_IA_HFCs',
                    'code': 1400,
                    'transactions': ['tr_06L'],
                    'transactionLabels': ['6L'],
                    'gases': ['id-2']
                },
                {
                    'form': 'F3A_S6A_IA_HFCs',
                    ...
                    'gases': ['id-1', 'id-2', 'id-3', 'id-4', 'id-19', 'id-20', 'id-21', 'id-22', 'id-183']
                },
                {
                    'form': 'F3A_S6A_IA_HFCs',
                    'code': 1400,
                ...
                /*updated 2024*/
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11A1', 'tr_11A1a', 'tr_11A1a1', 'tr_11A1a2', 'tr_11A1a3', 'tr_11A1a4', 'tr_11A1b', 'tr_11A1b1', 'tr_11A1b2', 'tr_11A1b3', 'tr_11A1b4', 'tr_11A1c', 'tr_11A1c1', 'tr_11A1c2', 'tr_11A1c3', 'tr_11A1c4', 'tr_11A2', 'tr_11A2a', 'tr_11A2a1', 'tr_11A2a1i', 'tr_11A2a1ii', 'tr_11A2a1iii', 'tr_11A2a2', 'tr_11A2a2i', 'tr_11A2a2ii', 'tr_11A2a2iii', 'tr_11A2a3', 'tr_11A2a3i', 'tr_11A2a3ii', 'tr_11A2a3iii', 'tr_11A2b', 'tr_11A2b1', 'tr_11A2b1i', 'tr_11A2b1ii', 'tr_11A2b1iii', 'tr_11A2b2', 'tr_11A2b2i', 'tr_11A2b2ii', 'tr_11A2b2iii', 'tr_11A2b3', 'tr_11A2b3i', 'tr_11A2b3ii', 'tr_11A2b3iii'],
                    'transactionLabels': ['11A1', '11A1a', '11A1a1', '11A1a2', '11A1a3', '11A1a4', '11A1b', '11A1b1', '11A1b2', '11A1b3', '11A1b4', '11A1c', '11A1c1', '11A1c2', '11A1c3', '11A1c4', '11A2', '11A2a', '11A2a1', '11A2a1i', '11A2a1ii', '11A2a1iii', '11A2a2', '11A2a2i', '11A2a2ii', '11A2a2iii', '11A2a3', '11A2a3i', '11A2a3ii', '11A2a3iii', '11A2b', '11A2b1', '11A2b1i', '11A2b1ii', '11A2b1iii', '11A2b2', '11A2b2i', '11A2b2ii', '11A2b2iii', '11A2b3', '11A2b3i', '11A2b3ii', '11A2b3iii'],
                    'gases': ['id-3', 'id-7', 'id-27', 'id-29', 'id-37', , 'id-48', 'id-147', 'id-196', 'id-232', 'id-328', 'id-375', 'id-424', 'id-558', 'id-578', 'id-676']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11B1', 'tr_11B2', 'tr_11B3', 'tr_11B4', 'tr_11B5'],
                    'transactionLabels': ['11B1', '11B2', '11B3', '11B4', '11B5'],
                    'gases': ['id-2', 'id-7', 'id-26', 'id-27', 'id-28', 'id-29', 'id-46', 'id-96', 'id-147', 'id-190', 'id-196', 'id-229', 'id-230', 'id-232', 'id-292', 'id-328', 'id-558', 'id-578', 'id-596', 'id-676']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11C1', 'tr_11C1a', 'tr_11C1b', 'tr_11C2', 'tr_11C2a', 'tr_11C2b'],
                    'transactionLabels': ['11C1', '11C1a', '11C1b', '11C2', '11C2a', '11C2b'],
                    'gases': ['id-3', 'id-7', 'id-26', 'id-27', 'id-29', 'id-37', 'id-146', 'id-147', 'id-196', 'id-230', 'id-232', 'id-375', 'id-578', 'id-676']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11E1', 'tr_11E2', 'tr_11E3', 'tr_11E4'],
                    'transactionLabels': ['11E1', '11E2', '11E3', '11E4'],
                    'gases': ['id-2', 'id-7', 'id-26', 'id-27', 'id-28', 'id-29', 'id-190', 'id-229','id-230']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11F1', 'tr_11F2', 'tr_11F3', 'tr_11F4', 'tr_11F5', 'tr_11F6', 'tr_11F7', 'tr_11F8', 'tr_11F9'],
                    'transactionLabels': ['11F1', '11F2', '11F3', '11F4', '11F5', '11F6', '11F7', '11F8', '11F9'],
                    'gases': ['id-3', 'id-7', 'id-26', 'id-27', 'id-29', 'id-37', 'id-190']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11H1', 'tr_11H2', 'tr_11H3', 'tr_11H4'],
                    'transactionLabels': ['11H1', '11H2', '11H3', '11H4'],
                    'gases': ['id-7', 'id-10', 'id-147', 'id-230']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11J1', 'tr_11J2'],
                    'transactionLabels': ['11J1', '11J2'],
                    'gases': ['id-7']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11M1', 'tr_11M2', 'tr_11M3', 'tr_11M4', 'tr_11M5'],
                    'transactionLabels': ['11M1', '11M2', '11M3', '11M4', '11M5'],
                    'gases': ['id-1']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    'transactions': ['tr_11N', 'tr_11O1', 'tr_11O2', 'tr_11O3', 'tr_11O4'],
                    'transactionLabels': ['11N', '11O1', '11O2', '11O3', '11O4'],
                    'gases': ['id-1']
                },
                {
                    'form': 'F2_S5_exempted_HFCs',
                ...
                },
                {
                    ...
                    'transactions': ['tr_06D'],
                    'transactionLabels': ['6D'],
                    'gases': ['id-2', 'id-3', 'id-5', 'id-7', 'id-9', 'id-16', 'id-26', 'id-27', 'id-28', 'id-29', 'id-37', 'id-38', 'id-39', 'id-42', 'id-43', 'id-44', 'id-45', 'id-46', 'id-52', 'id-89', 'id-91', 'id-136', 'id-137', 'id-141', 'id-146', 'id-147', 'id-148', 'id-155', 'id-190', 'id-292']
                },
                ...
                },
                {
                    ...
                    'transactions': ['tr_06K'],
                    'transactionLabels': ['6K'],
                    'gases': ['id-11', 'id-14', 'id-16', 'id-17', 'id-18', 'id-21', 'id-25', 'id-146', 'id-170', 'id-181', 'id-182']
                },
                {
                    'form': 'F3A_S6A_IA_HFCs',
                    'code': 1400,
                ...
                },
                {
                    ...
                    'transactions': ['tr_06O'],
                    'transactionLabels': ['6O'],
                    'gases': ['id-19', 'id-22', 'id-25', 'id-183']
                },
                {
                    'form': 'F3A_S6A_IA_HFCs',
                    'code': 1400,
                    ...
                    for (var j = 0; j < $scope.instance.FGasesReporting.ReportedGases.length; j++) {
                        ...
                        if (!isInWhiteList && qcRules.gases.length > 0) {
                            ...
                            for (var m = 0; m < qcRules.transactions.length; m++) {
                                ...
                                if (gasElement) {
                                    if ((gasElement.Amount != null && gasElement.Amount != '' && parseFloat(gasElement.Amount) > 0) ||
            ...
            $scope.getQC1400Translation = function(whitelist, transactionCode, gas) {
                ...
                return $translate.instant(m, {
                    code: transactionCode.replace(/^11/, '11_'),
                    gas: gas.Name
                });
            };
            ...
            $scope.reCalculateSheet1 = function() {
                ...
                var totalRowCalculations = ['tr_02A', 'tr_02App', 'tr_02D', 'tr_03A', 'tr_03App', 'tr_03H'];
                ...
                var tradingPartnerTotalAmounts = ['tr_01C','tr_02H'];
                var fieldsToCalculate = ['tr_01D', 'tr_01H', 'tr_01K', 'tr_03C', 'tr_04D', 'tr_04E', 'tr_04I', 'tr_04J', 'tr_8D'];
            ...
            //This function recalculates all values related to sheet2a
            $scope.reCalculateSheet2a = function () {
                
            }; //end of function reCalculateSheet2a
            ...
            $scope.reCalculateSheet4 = function() {
                ...
                if ($scope.instance.FGasesReporting.F4_S9_IssuedAuthQuata.Verified == null) {
                    $scope.instance.FGasesReporting.F4_S9_IssuedAuthQuata.Verified = false;
                }
            }; //end of function reCalculateSheet4

            //This function checks 4M field and if 4M > 0 on HFC or HFC mixtures gases, block quota nil report tickbox
            $scope.check4MFieldQuotaNilReport = function () {
                if ($scope.isSheet4NilReportRequired()) {
                    var blockNilReportTickBox = false;
                    ...
                    arrayUtil.forEach(section4Gases, function (section4Gas) {
                        if (section4Gas.GasGroup == 'HFCs' || section4Gas.GasGroup == 'HFC mixtures' || (section4Gas.GasGroup == 'CustomMixture' && section4Gas.BlendComponents.Component && section4Gas.BlendComponents.Component.filter(f => (f.GasGroupId == 1)).length > 0)) {
                            ...
                            if (gasAmount04M && gasAmount04M.amount > 0) {
                                blockNilReportTickBox = true;
                            }
                        }
                    });
                    if (typeof nilReportCheckbox !== 'undefined') { // checking nilReportCheckbox variable exist
                        var sum09Aimp = viewModel.sheet4.section9.getTr09A_impSumOfPartnerAmounts();
                        var sum9Aadd = viewModel.sheet4.section9.getTr09A_addSumOfPartnerAmounts();
                        if (blockNilReportTickBox || sum09Aimp > 0 || sum9Aadd > 0) {
                            if (nilReportCheckbox.checked || $scope.instance.FGasesReporting.GeneralReportData.Activities['RQA'] == false) { // if tickbox is checked, uncheck it and change XML
                                nilReportCheckbox.checked = false;
                            }
                            // disable tickbox
                            nilReportCheckbox.disabled = true;
                        } else {
                            // enable tickbox
                            nilReportCheckbox.disabled = false;
                        }
                    }
            ...
            $scope.isSheet4NilReportRequired = function () {
                return viewModel.sheetActivities.isRQA();
            };

            $scope.isSheet4VerificationRequired = function() {
                return $scope.isTr_09COver1000() || $scope.tr05CValueHasValueDefined();
            };

            $scope.isTr_09COver1000 = function() {
                return $scope.instance.FGasesReporting.F4_S9_IssuedAuthQuata.tr_09C.Amount >= 1000;
            };
            ...
            $scope.reCalculateSheet6 = function() {
                ...
                //calculate total gas reports
                var totalRowCalculations = ['tr_8D'];
                for (var i = 0; i < totalRowCalculations.length; i++) {
                    $scope.doCalculationTotalForRow(formId, totalRowCalculations[i]);
                }
            ...
            $scope.reInitSheet8 = function() { 
                // In case 'Eq-I-RACHP-HFC` was selected, deselected and selected again, re-populate sheet8 Gas data.
                // This is normally done by `addGasForReporting`.
                var element = 'F8_S12';
                arrayUtil.forEach($scope.instance.FGasesReporting.ReportedGases, function(reportedGas) {
                    // First check to see if the gas is not already in the list
                    var exists = false;
                    for (var i = 0; i < $scope.instance.FGasesReporting[element].Gas.length; i++) {
                        if ($scope.instance.FGasesReporting[element].Gas[i].GasCode === reportedGas.GasId) {
                            exists = true;
                            break;
                        }
                    }
                    if (!exists) {
                        ...
                        if ($scope.instance.FGasesReporting[element].Gas[lastIndex]) {
                            $scope.instance.FGasesReporting[element].Gas[lastIndex].GasCode = reportedGas.GasId;
                            $scope.instance.FGasesReporting[element].Gas[lastIndex].tr_12A.Transaction = [];
                            $scope.instance.FGasesReporting[element].Gas[lastIndex].tr_12aA.Transaction = [];
                            $scope.instance.FGasesReporting[element].Gas[lastIndex].tr_12B.Transaction = [];
                            $scope.instance.FGasesReporting[element].Gas[lastIndex].tr_12aB.Transaction = [];
                        }
                        
                    }
                });

                // $scope.instance.FGasesReporting[element].Gas.tr_12A_TradePartners.Partner = [];
            ...
            $scope.isTabVisible = function(tabId) {
                ...
                var atLeastOneActivitySelected =
                    mainCondition && ($scope.instance.FGasesReporting.GeneralReportData.Activities['P'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['I'] ||
                        $scope.instance.FGasesReporting.GeneralReportData.Activities['E'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['RC'] ||
                        $scope.instance.FGasesReporting.GeneralReportData.Activities['RQ'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['RH'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['FU'] ||
                        ...
                        $scope.instance.FGasesReporting.GeneralReportData.Activities['auth'] ||
                        $scope.instance.FGasesReporting.GeneralReportData.Activities['RQA']);
                ...
                switch (tabId) {
                    ...
                    case 'Sheet1':
                        return subMainCondition && ($scope.instance.FGasesReporting.GeneralReportData.Activities['P'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['I'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['E'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['RC']);
                    case 'Sheet2':
                    ...
                    case 'Sheet2a':
                        return subMainCondition && ($scope.instance.FGasesReporting.GeneralReportData.Activities['RQ'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['RH']);
                    case 'Sheet3':
                        return subMainCondition && ($scope.instance.FGasesReporting.GeneralReportData.Activities['P'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['I'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['RC']);
                    case 'Sheet4':
                        return subMainCondition && ($scope.instance.FGasesReporting.GeneralReportData.Activities['P-HFC'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['I-HFC'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['auth'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['RC'] || $scope.instance.FGasesReporting.GeneralReportData.Activities['RQA']);
                    case 'Sheet6a':
                        return subMainCondition && $scope.instance.FGasesReporting.GeneralReportData.Activities['FU'];
                    case 'Sheet6b':
                        return subMainCondition && $scope.instance.FGasesReporting.GeneralReportData.Activities['D'];
                    case 'Sheet7':
                        return subMainCondition && ($scope.instance.FGasesReporting.GeneralReportData.Activities['Eq-I']);
                    case 'Sheet8':
                        return subMainCondition && ($scope.instance.FGasesReporting.GeneralReportData.Activities['Eq-I-RACHP-HFC']);
                    case 'Sheet9':
                        return subMainCondition && ($scope.instance.FGasesReporting.GeneralReportData.Activities['Eq-I-RACHP-HFC']);
                    default:
                        return true;
            ...
            $scope.onTabChange = function(tabId) {
                ...
                switch (tabId) {
                    ...
                    case 'Sheet4':
                        $scope.reCalculateSheet4();
                        $scope.check4MFieldQuotaNilReport();
                        break;
                    case 'Sheet6a':
                        break;
                    case 'Sheet6b':
            ...
            $scope.getCommentDataForTr02D = function(gasIndex, countryIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02D.CountrySpecific.Country[countryIndex];
            };

            $scope.getCommentDataForTr02App = function (gasIndex, countryIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02App.CountrySpecific.Country[countryIndex];
            };

            $scope.mandatoryCommentForTr02I = function (gasIndex) {
                var data = $scope.getCommentDataForTr02I(gasIndex);
                var caption = $scope.getCommentModalCaptionForTr02I(gasIndex);
                $scope.mandatoryCommentForGasAmount(data, caption, function () {
                    $scope.reCalculateSheet1();
                }, $translate.instant("sheet1.tr-02i-mandatory-comment"));
            };

            $scope.getCommentDataForTr02I = function (gasIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02I;
            };

            $scope.getCommentModalCaptionForTr02I = function (gasIndex) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;
                return "[gas] emissions under special customs procedures (2I)".replace("[gas]", gasName);
            };

            $scope.getCommentDataForTr03App = function (gasIndex, countryIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03App.CountrySpecific.Country[countryIndex];
            };
            ...
            $scope.openCommentModalForTr02D = function(gasIndex, countryIndex) {
                var data = $scope.getCommentDataForTr02D(gasIndex, countryIndex);
                $scope.openCommentModalCountry(data);
            };

            $scope.openCommentModalForTr02App = function (gasIndex, countryIndex) {
                var data = $scope.getCommentDataForTr02App(gasIndex, countryIndex);
                $scope.openCommentModalCountry(data);
            };

            $scope.openCommentModalForTr03App = function (gasIndex, countryIndex) {
                var data = $scope.getCommentDataForTr03App(gasIndex, countryIndex);
                $scope.openCommentModalCountry(data);
            };

            $scope.getCommentModalCaptionForTr02D = function(gasIndex, countryIndex) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;
                var countryName = viewModel.sheet1.section2.getTr02Countrys()[countryIndex].CountryName;

                return "[gas] supplies to [country]".replace("[gas]", gasName).replace("[country]", countryName);
            };            

            $scope.getCommentDataForTr03H = function(gasIndex, countryIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03H.CountrySpecific.Country[countryIndex];
            };        

            $scope.openCommentModalForTr03H = function(gasIndex, countryIndex) {
                var data = $scope.getCommentDataForTr03H(gasIndex, countryIndex);
                $scope.openCommentModalCountry(data);
            };

            $scope.getCommentModalCaptionForTr03H = function(gasIndex, countryIndex) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;
                var countryName = viewModel.sheet1.section3.getTr03Countrys()[countryIndex].CountryName;

                return "[gas] supplies to [country]".replace("[gas]", gasName).replace("[country]", countryName);
            };      

            $scope.mandatoryCommentForTr02D = function(gasIndex, countryIndex) {
                var data = $scope.getCommentDataForTr02D(gasIndex, countryIndex);
                var caption = $scope.getCommentModalCaptionForTr02D(gasIndex, countryIndex);
                $scope.mandatoryCommentForGasAmountCountry(data, caption, function() {
                    $scope.reCalculateSheet1();
                }, $translate.instant("validation_messages.qc_1401.error_text"));
            };

            $scope.mandatoryCommentForTr02App = function (gasIndex, countryIndex, isPreBlended) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;
                var data = $scope.getCommentDataForTr02App(gasIndex, countryIndex);
                var caption = $scope.getCommentModalCaptionForTr02App(gasIndex, countryIndex);
                if (isPreBlended == true) {
                    $scope.mandatoryCommentForBlendedGasAmountCountry(data, caption, function () {
                        $scope.reCalculateSheet1();
                    }, $translate.instant("validation_messages.qc_2415.error_text", {
                        activity: "imports",
                        section: "2F (formerly 2A_pp)"
                    }));
                } else {
                    $scope.mandatoryCommentForNotBlendedGasAmountCountry(data, caption, function () {
                        $scope.reCalculateSheet1();
                    }, $translate.instant("validation_messages.qc_2416.error_text", {
                        gas: gasName,
                        activity: "imports"
                    }));
                }
            ...
            $scope.mandatoryCommentForTr03App = function (gasIndex, countryIndex, isPreBlended) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;
                var data = $scope.getCommentDataForTr03App(gasIndex, countryIndex);
                var caption = $scope.getCommentModalCaptionForTr03App(gasIndex, countryIndex);
                if (isPreBlended == true) {
                    $scope.mandatoryCommentForBlendedGasAmountCountry(data, caption, function () {
                        $scope.reCalculateSheet1();
                    }, $translate.instant("validation_messages.qc_2415.error_text", {
            ...
            $scope.mandatoryCommentForTr03H = function(gasIndex, countryIndex) {
                var data = $scope.getCommentDataForTr03H(gasIndex, countryIndex);
                var caption = $scope.getCommentModalCaptionForTr03H(gasIndex, countryIndex);
                $scope.mandatoryCommentForGasAmountCountry(data, caption, function() {
                    $scope.reCalculateSheet1();
                }, $translate.instant("validation_messages.qc_1401.error_text"));
            };            
            ...
            $scope.openCommentModalForTr05C = function (gasIndex, tradePartnerIndex) {
                var data = $scope.getCommentDataForTr05C(gasIndex, tradePartnerIndex);
                $scope.openCommentModalTradePartner(data);
            };

            $scope.getCommentDataForTr05C = function (gasIndex, tradePartnerIndex) {
                return $scope.instance.FGasesReporting.F2_S5_exempted_HFCs.Gas[gasIndex].tr_05C.TradePartner[tradePartnerIndex];
            };

            $scope.getCommentDataForTr02App = function (gasIndex, tradePartnerIndex) {
                
               return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02App.CountrySpecific.Country[tradePartnerIndex];
            };

            $scope.getCommentDataForTr03App = function (gasIndex, tradePartnerIndex) {

                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03App.CountrySpecific.Country[tradePartnerIndex];
            };

            $scope.getCommentModalCaptionForTr02App = function (gasIndex, countryIndex) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;
                // = viewModel.sheet2.section5.getTr02AppTradePartners()[tradePartnerIndex].CompanyName;
                var country = $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_02App.CountrySpecific.Country[countryIndex];
                var countryName = viewModel.sheet1.section2.getTr02Countrys()[countryIndex].CountryName;
                return "[gas] supplies to [country]".replace("[gas]", gasName).replace("[country]", countryName);
            };

            $scope.getCommentModalCaptionForTr03App = function (gasIndex, countryIndex) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;
                
               // var country = $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_03App.CountrySpecific.Country[countryIndex];
                var countryName = viewModel.sheet1.section3.getTr03Countrys()[countryIndex].CountryName;
                return "[gas] supplies to [country]".replace("[gas]", gasName).replace("[country]", countryName);
            };
            ...
            $scope.mandatoryCommentForTr06T = function(gasIndex) {
                ...
                $scope.mandatoryCommentForGasAmount(data, caption, function() {
                    $scope.doCalculationForFields(gasIndex, ['tr_06W']);
                }, $translate.instant("validation_messages.qc_1403.error_text", {
                    gasName: gasName
                }));
            };
            ...
            /**START explanation field for tr_07A_a */
            $scope.openCommentModalForTr07Aa = function (gasIndex) {
                var data = $scope.getCommentDataForTr07Aa(gasIndex);
                $scope.openCommentModal(data);
            };

            $scope.getCommentDataForTr07Aa = function (gasIndex) {
                return $scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_07Aa;
            };

            /**START MAndatory explanation field for tr_01A_fs */
            $scope.getCommentDataForTr01A_FS = function (gasIndex, countryIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01A_fs.CountrySpecific.Country[countryIndex];
            };

            $scope.openCommentModalForTr01A_FS = function (gasIndex, countryIndex) {
                var data = $scope.getCommentDataForTr01A_FS(gasIndex, countryIndex);
                if(objectUtil.isNull(data.Amount) || data.Amount === 0)
                    return;
                $scope.openCommentModal(data);
            };
            $scope.getCommentModalCaptionForTr01A_FS = function(gasIndex) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;

                return "[gas] feedstock use".replace("[gas]", gasName);
            };

            $scope.mandatoryCommentForTr01A_FS = function(gasIndex, countryIndex) {
                var data = $scope.getCommentDataForTr01A_FS(gasIndex, countryIndex);
                var caption = $scope.getCommentModalCaptionForTr01A_FS(gasIndex);
                $scope.mandatoryCommentForGasAmountCountry(data, caption, function () {
                    $scope.reCalculateSheet1();
                }, $translate.instant("validation_messages.qc_1401.error_text"));
            };
            /**END MAndatory explanation field for tr_01A_fs */

            $scope.getCommentDataForTr04A = function (reportedGasIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[reportedGasIndex].tr_04A;
            };


            $scope.mandatoryCommentForTr04A = function (reportedGasIndex) {
                var gasAmounts = viewModel.sheet1.section4.getGasAmounts("tr_04A");
                var stock = viewModel.getGasStockByTransaction("4F", gasAmounts[reportedGasIndex].id);
                if (stock != null) {

                    var gasName = viewModel.getReportedGases()[reportedGasIndex].Name;
                    var data = $scope.getCommentDataForTr04A(reportedGasIndex);
                    var caption = $scope.getCommentModalCaptionForTr04(reportedGasIndex);
                    var msg = $translate.instant('sheet1.tr-04-mandatory-comment');

                    msg = msg.replace(/\[gas\]/g, gasName);
                    ...
                    msg = msg.replace(/\[field_code\]/g, "04A");
                    msg = msg.replace(/\[stock_field_code\]/g, "04F");

                    $scope.mandatoryCommentForGasAmountTransactions(data, caption, function () {
                        $scope.reCalculateSheet1();
                    }, msg);
                }
            };

            $scope.getCommentDataForTr04Aa = function (reportedGasIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[reportedGasIndex].tr_04Aa;
            };


            $scope.mandatoryCommentForTr04Aa = function (reportedGasIndex) {
                var gasAmounts = viewModel.sheet1.section4.getGasAmounts("tr_04Aa");
                var stock = viewModel.getGasStockByTransaction("4F", gasAmounts[reportedGasIndex].id);
                if (stock != null) {

                    var gasName = viewModel.getReportedGases()[reportedGasIndex].Name;
                    var data = $scope.getCommentDataForTr04Aa(reportedGasIndex);
                    var caption = $scope.getCommentModalCaptionForTr04(reportedGasIndex);
                    var msg = $translate.instant('sheet1.tr-04-mandatory-comment');
                    ...
                    msg = msg.replace(/\[field_code\]/g, "04Aa");
                    msg = msg.replace(/\[stock_field_code\]/g, "04F");
            ...
            $scope.getCommentDataForTr04B = function (reportedGasIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[reportedGasIndex].tr_04B;
            };

            $scope.mandatoryCommentForTr04B = function (reportedGasIndex) {
                var gasAmounts = viewModel.sheet1.section4.getGasAmounts("tr_04B");
                var stock = viewModel.getGasStockByTransaction("4F", gasAmounts[reportedGasIndex].id);
                if (stock != null) {
                    var data = $scope.getCommentDataForTr04B(reportedGasIndex);
                    var caption = $scope.getCommentModalCaptionForTr04(reportedGasIndex);
                    var gasName = viewModel.getReportedGases()[reportedGasIndex].Name;
                    ...
                    msg = msg.replace(/\[field_code\]/g, "04B");
                    msg = msg.replace(/\[stock_field_code\]/g, "04G");
            ...
            $scope.getCommentDataForTr04C = function (reportedGasIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[reportedGasIndex].tr_04C;
            };

            $scope.mandatoryCommentForTr04C = function (reportedGasIndex) {
                var gasAmounts = viewModel.sheet1.section4.getGasAmounts("tr_04C");
                var stock = viewModel.getGasStockByTransaction("4F", gasAmounts[reportedGasIndex].id);
                if (stock != null) {
                    var data = $scope.getCommentDataForTr04C(reportedGasIndex);
                    var caption = $scope.getCommentModalCaptionForTr04(reportedGasIndex);
                    var gasName = viewModel.getReportedGases()[reportedGasIndex].Name;

                    var stock = viewModel.getGasStockByTransaction("4H", gasAmounts[reportedGasIndex].id);
                    ...
                    msg = msg.replace(/\[field_code\]/g, "04C");
                    msg = msg.replace(/\[stock_field_code\]/g, "04H");
            ...
            $scope.getCommentModalCaptionForTr04 = function (reportedGasIndex) {

                var gasName = viewModel.getReportedGases()[reportedGasIndex].Name;
                return "[gas] feedstock use".replace("[gas]", gasName);
            };

            $scope.mandatoryCommentForGasAmountTransactions = function (data, confirmationCaption, resetAmountCallback, bodyText) {
                if (numericUtil.toNum(data.Amount, 0) !== 0 && stringUtil.isBlank(data.Comment)) {
                    $scope.showCommentConfirmationModalGas(data, confirmationCaption, resetAmountCallback, bodyText);
                } else {
                    $scope.resetGasComment(data);
                }
            };

            $scope.showCommentConfirmationModalGas = function (data, confirmationCaption, resetAmountCallback, bodyText) {
                commentModalService.open($scope, 'lg', 'comment-confirmation-modal.html', 'ConfirmCommentDialogController', data, function () {
                    $scope.openCommentModalTradePartner(data, resetAmountCallback);
                        ...
                        $scope.onCountrySpecificGasAmountCommentReset(data, resetAmountCallback);
                }, {
            ...
            /**START MAndatory explanation field for tr_8C */
            $scope.getCommentDataForTr8C = function (gasIndex) {
                return $scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_8C;
            };

            $scope.getCommentModalCaptionForTr8C = function (gasIndex) {
                var gasName = viewModel.getReportedGases()[gasIndex].Name;
                return "[gas] destruction technology".replace("[gas]", gasName);
            };

            $scope.mandatoryCommentForTr8C = function (gasIndex) {
                /*var data = $scope.getCommentDataForTr8C(gasIndex);
                var caption = $scope.getCommentModalCaptionForTr8C(gasIndex);
                $scope.mandatoryCommentForGasAmountTransactions(data, caption, function () {
                    $scope.reCalculateSheet6();
                }, 'Destruction technology to be specified');*/
                $scope.ModalController.open('lg', 'CommentAddEditModal.html', 'CommentAddEditModalInstanceController', $scope.instance.FGasesReporting.F6_FUDest.Gas[gasIndex].tr_8C, null, { title: 'Destruction technology to be specified' });

            };
            /**END MAndatory explanation field for tr_8C */
            ...
            $scope.mandatoryCommentForGasAmountCountry = function(data, confirmationCaption, resetAmountCallback, bodyText) {
                if (numericUtil.toNum(data.Amount, 0) !== 0 && stringUtil.isBlank(data.Comment)) {
                    $scope.showCommentConfirmationModalCountry(data, confirmationCaption, resetAmountCallback, bodyText);
                } else {
                    $scope.resetGasComment(data);
                }
            };

            $scope.mandatoryCommentForBlendedGasAmountCountry = function (data, confirmationCaption, resetAmountCallback, bodyText) {
                if (numericUtil.toNum(data.Amount, 0) == 0 && stringUtil.isBlank(data.Comment)) {
                    $scope.showCommentConfirmationModalCountry2(data, confirmationCaption, resetAmountCallback, bodyText);
                } else {
                    $scope.resetGasComment(data);
                }
            };

            $scope.mandatoryCommentForNotBlendedGasAmountCountry = function (data, confirmationCaption, resetAmountCallback, bodyText) {
                if (numericUtil.toNum(data.Amount, 0) != 0 && stringUtil.isBlank(data.Comment)) {
                    $scope.showCommentConfirmationModalCountry(data, confirmationCaption, resetAmountCallback, bodyText);
                } else {
                    $scope.resetGasComment(data);
            ...
            $scope.showCommentConfirmationModalCountry = function(data, confirmationCaption, resetAmountCallback, bodyText) {
                commentModalService.open($scope, 'lg', 'comment-confirmation-modal.html', 'ConfirmCommentDialogController', data, function() {
                    $scope.openCommentModalCountry(data, resetAmountCallback);
                }, function() {
                    $scope.onCountrySpecificGasAmountCommentReset(data, resetAmountCallback);
                }, {
                    title: confirmationCaption,
            ...
            $scope.showCommentConfirmationModalCountry2 = function (data, confirmationCaption, resetAmountCallback, bodyText) {
                commentModalService.open($scope, 'lg', 'comment-confirmation-modal2.html', 'ConfirmCommentDialogController', data, function () {
                    $scope.openCommentModalCountry(data, resetAmountCallback);
                }, function () {
                    $scope.onCountrySpecificGasAmountCommentReset(data, resetAmountCallback);
                }, {
            ...
            $scope.openCommentModalCountry = function(data, resetAmountCallback) {
                var onCommentReset = null;
            ...
            $scope.onCountrySpecificGasAmountCommentReset = function(data, callback) {
                if (stringUtil.isBlank(data.Comment)) {
                    data.Amount = null;
                    objectUtil.call(callback);
                }
            ...
            $scope.mandatoryCommentForGasAmount = function(data, confirmationCaption, resetAmountCallback, bodyText) {
                if ((numericUtil.toNum(data.amount, 0) !== 0 || numericUtil.toNum(data.Amount, 0) !== 0) && stringUtil.isBlank(data.Comment)) {
