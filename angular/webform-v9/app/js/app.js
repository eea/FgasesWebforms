...
(function() {
    ...
    app.run(function($rootScope, promiseTracker, $location, tabService, errorMapperService) {
        ...
        tabService.setTabs([
            ...
            { "id": "Sheet2a",        "active": false },
            {"id":"Sheet3",           "active" : false},
            {"id":"Sheet4",           "active" : false},
            { "id": "Sheet6a",        "active": false },
            { "id": "Sheet6b",        "active": false },
    ...
    app.config(function(languageChangerProvider) {
        ...
        languageChangerProvider.setLanguageFilePrefix('fgases-labels-2024-');
...
function getWeightedGWP(componentsForGWP){
    ...
    for (var l = 0; l < copyOfGasComponentsForGWP.length; l++){
        ...
        if (copyOfGasComponentsForGWP[l].GWP_AR4_AnnexIV !== undefined && copyOfGasComponentsForGWP[l].GWP_AR4_AnnexIV !== null) {
