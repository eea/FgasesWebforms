...
(function() {
    angular.module('FGases.viewmodel').factory('ViewModelSheet1', [
        ...
        'ViewModelSectionBase', 'gasHelper', 'objectUtil', 'arrayUtil',
        
        function (ViewModelSectionBase, gasHelper, objectUtil, arrayUtil) {
            ...
            ViewModelSheet1Section1.prototype.isGasApplicableToTr01Aa = function (reportedGas) {
                return this._isHfcApplicable(reportedGas);
            };

            ViewModelSheet1Section1.prototype.isGasApplicableToTr01A_a = function (reportedGas) {
                return this._isHfcApplicable(reportedGas);
            };

            ViewModelSheet1Section1.prototype.isGasApplicableToTr01A_a_own = function (reportedGas) {
                return this._isHfcApplicable(reportedGas);
            };

            ViewModelSheet1Section1.prototype.isGasApplicableToTr01A_a_other = function (reportedGas) {
                return this._isHfcApplicable(reportedGas);
            };

            ViewModelSheet1Section1.prototype.getTr01A_a_otherOwnTradePartner = function () {
                return this._getTrOwnTradePartner(this.getSectionData().tr_01A_a_other_ExtDestruction.Partner);
            };
            ...
            ViewModelSheet1Section1.prototype.getTr01COwnTradePartner = function () {
                return this._getTrOwnTradePartner(this.getSectionData().tr_01C_TradePartners.Partner);
            };

            ViewModelSheet1Section1.prototype.isGasApplicableToTr01A_fs = function (reportedGas) {
                return this._isHfcApplicable(reportedGas) && reportedGas.GasGroup == 'HFCs';
            };

            ViewModelSheet1Section1.prototype.isGasApplicableToTr01A_fs1 = function (reportedGas) {
                return gasHelper.isGasHFC23(reportedGas);
            };
            ...
            ViewModelSheet1Section1.prototype._getTrOwnTradePartner = function (transactionPartners) {
        ...
        function (ViewModelSectionBase, objectUtil) {
            ...
            ViewModelSheet1Section2.prototype.getTr02Countrys = function() {
                return this.getSectionData().tr_02A_Countries.Country;
            };
        ...
        function (ViewModelSectionBase, objectUtil) {
            ...
            ViewModelSheet1Section3.prototype.getTr03Countrys = function() {
                return this.getSectionData().tr_03A_Countries.Country;
            };            
        ...
        function (ViewModelSectionBase, gasHelper, objectUtil, numericUtil) {
            ...
            ViewModelSheet1Section4.prototype.isGasApplicableToTr04Aa = function (reportedGas) {
                return this._isSection4ApplicableGas(reportedGas);
            };
            ...
            ViewModelSheet1Section4.prototype.isGasApplicableToTr04Fa = function (reportedGas) {
                return this._isSection4ApplicableGas(reportedGas);
            };
            ...
            ViewModelSheet1Section4.prototype._isSection4ApplicableGas = function(reportedGas) {
                ...
                return activities.isI() || activities.isP() || activities.isRC() || !gasHelper.isHfcBasedGas(reportedGas);
            };
            
            ViewModelSheet1Section4.prototype.isProducerOrImporter = function() {
                var activities = this.getRoot().sheetActivities;
                return activities.isI() || activities.isP();
            };
            ...
            ViewModelSheet1Section4.prototype.applyStockValues = function(gas, forceOverwrite) {
              ...
              /*  var stock04FApplied = this._applyStockValues(gasId, '4F', 'tr_04A', forceOverwrite);
                ...
                var stock04FApplied = this._applyStockValues(gasId, '4A', 'tr_04A', forceOverwrite);
                var stock04GApplied = this._applyStockValues(gasId, '4B', 'tr_04B', forceOverwrite);
                var stock04HApplied = this._applyStockValues(gasId, '4C', 'tr_04C', forceOverwrite);
