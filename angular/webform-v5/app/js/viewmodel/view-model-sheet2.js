...
(function() {
    angular.module('FGases.viewmodel').factory('ViewModelSheet2', [
        ...
        'ViewModelObjectBase', 'ViewModelSheet2Section5','ViewModelSheet2Section13aA', 'objectUtil',
        
        function(ViewModelObjectBase, ViewModelSheet2Section5, ViewModelSheet2Section13aA, objectUtil) {
            ...
            function ViewModelSheet2(viewModel) {
                ...
                this.section13aA = new ViewModelSheet2Section13aA(this);
            }
    ...
    ]).factory('ViewModelSheet2Section13aA', [
        
        'ViewModelSectionBase', 'sheet2Validator', 'gasHelper', 'objectUtil', 'arrayUtil',
        
        function(ViewModelSectionBase, sheet2Validator, gasHelper, objectUtil, arrayUtil) {
            function ViewModelSheet2Section13aA(sheet2ViewModel) {
                if (!(this instanceof ViewModelSheet2Section13aA)) {
                    return new ViewModelSheet2Section13aA(sheet2ViewModel);
                }
                
                ViewModelSectionBase.call(this, sheet2ViewModel);
            }
            
            objectUtil.chainConstructor(ViewModelSectionBase, ViewModelSheet2Section13aA);               

            return ViewModelSheet2Section13aA;
        }
    ]);
})();
