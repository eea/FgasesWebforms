        ...
        function($scope, $window, $rootScope, dataRepository, languageChanger, $sce, $location, $filter, $translate,
            ...
            $scope.activitySelectionChanged = function(activity) {
                ...
                if (activity === 'I-HFC' || activity === 'Eq-I-RACHP-HFC' || activity === 'Eq-I-other') {
                    if ($scope.CompanyExtraData && $scope.instance.FGasesReporting.GeneralReportData.Activities[activity]) {
                        ...
                        if (activity === 'I-HFC' && types.indexOf('FGAS_PRODUCER_IMPORTER_HFCS') < 0) {
                        ...
                        } else if ((activity === 'Eq-I-RACHP-HFC' || activity === 'Eq-I-other') && types.indexOf('FGAS_IMPORTER_OF_EQUIPMENT_HFCS') < 0) {
                ...
                'P_I': {
                    'clearStatements': [{
                        ...
                        },
                        {
                            ...
                            fields: [
                                { 'form': 'F2_S5_exempted_HFCs', 'rows': ['tr_05A', 'tr_05B', 'tr_05C', 'tr_05D', 'tr_05E', 'tr_05F', 'tr_05G', 'tr_05H', 'tr_05I', 'tr_05J', 'tr_05R', 'tr_13aA', 'tr_13aB', 'tr_13aC'] },
            ...
            $scope.initFormulas = function() {
                                                 ...
                                                 $scope.formulasForRows = {
                                                     ...
                                                     'tr_04M': { 'formula': ['tr_01E', '+', 'tr_02A', '-', 'tr_02B', '-', 'tr_03B', '+', 'tr_04C', '-', 'tr_04H'], 'dependents': ['tr_05H', 'tr_13aA'] },
                                                     'tr_05G': { 'formula': v_tr_05G_formula_2018, 'dependents': ['tr_05I', 'tr_13aA'] },
                                                     ...
                                                     'tr_13aA': { 'formula': ['tr_04M', '-' , 'tr_05G'], 'dependents': 'tr_13aC'  },
                                                     'tr_13aC': { 'formula': ['tr_13aA', '-' , 'tr_13aB']}
            ...
            $scope.form7specificRanges = {
                ...
                'tr_11A05': { 'Outside': false, 'QCCode': '2300', 'lower': 0.1, 'upper': 3 },
                'tr_11A06': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 50 },
                ...
                'tr_11B02': { 'Outside': false, 'QCCode': '2300', 'lower': 0.03, 'upper': 10 },
                ...
                'tr_11E04': { 'Outside': false, 'QCCode': '2300', 'lower': 0.035, 'upper': 5 },
                'tr_11F01': { 'Outside': false, 'QCCode': '2300', 'lower': 0.3, 'upper': 1.5 },
                'tr_11F02': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 20 },
                'tr_11F03': { 'Outside': false, 'QCCode': '2300', 'lower': 0.3, 'upper': 1.5 },
            ...
            $scope.unusualGasValidationsGroup1 = [/*{
                ...
                },
                {
                    ...
                    'gases': ['id-3', 'id-7', 'id-27', 'id-29', 'id-306']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                    ...
                    'gases': ['id-2','id-3','id-5','id-7','id-9','id-14','id-16','id-19','id-21','id-26','id-27','id-29','id-46','id-48','id-96','id-229','id-301','id-302','id-303','id-306','id-504','id-507','id-510','id-512','id-514','id-520','id-522','id-523','id-530','id-541','id-543','id-545','id-551','id-553']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
                ...
                },
                {
                    ...
                    'gases': ['id-2','id-7','id-26','id-27','id-28','id-29','id-46','id-96','id-345']
                },
                {
                    'form': 'F7_s11EquImportTable',
                    'code': 1400,
