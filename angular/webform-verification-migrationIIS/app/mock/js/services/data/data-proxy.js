...
(function() {
    angular.module('FGases.services.data').factory('dataProxy', [
        ...
        '$window', '$rootScope', '$http', 'HttpMock', 'objectUtil', 'transactionYearProvider', 'ParseFGasesReportingXml',

        function($window, $rootScope, $http, HttpMock, objectUtil, transactionYearProvider, ParseFGasesReportingXml) {
            function DataProxy() { }
          ...
          /*  DataProxy.prototype.getFGases = function() {
            ...
            DataProxy.prototype.getAuditorData = function () {
                return $http.get('mock/data/get_audit_metadata.json', { tracker: $rootScope.loadingTracker });
            };
            ...
            DataProxy.prototype.getAuthorisationData = function(companyId, transactionYear, onSuccess, onError) {
                var resourceUri = 'mock/data/fgases-authorisations.json';

                return $http.get(resourceUri, {tracker : $rootScope.loadingTracker})
                        .success(function(data) {
                            objectUtil.call(onSuccess, data);
                        }).error(function() {
                            objectUtil.call(onError);
            ...
            DataProxy.prototype.getFGasesReportingXmlUrl = function(dataReportUrl) {
                return $http.get('mock/data/fgases-reporting.json', { tracker: $rootScope.loadingTracker });
            };
            ...
            DataProxy.prototype.getFGasesReporting = function (xml_url) {
              ...
              /*  return $http.get('mock/data/fgases-reporting.json', { tracker: $rootScope.loadingTracker })
                ...
                */
                let url = 'http://localhost:59758/app/xmlPruebas/Fluorinated_gases__F-Gases__reporting_2025_transaction_year__2.xml';
