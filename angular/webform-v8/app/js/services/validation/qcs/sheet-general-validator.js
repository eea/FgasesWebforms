            ...
            sheetGeneralValidator.prototype._createRuleQC24120 = function () {
                return {
                    ...
                    validate: function (viewModel) {
                        ...
                        if (viewModel._instance.FGasesReporting.GeneralReportData.Company.CompanyId == "" ||
                            viewModel._instance.FGasesReporting.GeneralReportData.Company.CompanyId == null ||
                            viewModel._instance.FGasesReporting.GeneralReportData.Company.CompanyName == "" ||
                            viewModel._instance.FGasesReporting.GeneralReportData.Company.CompanyName == null
                        ) {
                            var error = sheetValidationObjectFactory.createValidationError(this.qccode);
                            result.errors.push(error);
                        }
