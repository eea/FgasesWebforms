                ...
                return {
                    ...
                    validate: function (viewModel) {
                        ...
                        arrayUtil.forEach(section4Gases, function (section4Gas) {
                            ...
                            var amountSubs = Math.round((amount04I - amount04D) * 1000) / 1000 
                ...
                return {
                    ...
                    validate: function (viewModel) {
                        ...
                        for (var i = 0; i < gases.length; i++) {
                            ...
                            if (tr_01A_fs.amount > Math.max(tr_01E.amount,0)) {
                                var error = sheetValidationObjectFactory.createValidationError(that.qccode);
           ...
           Sheet1Validator.prototype._createRuleQc2415 = function (transaction) {
            ...
            Sheet1Validator.prototype._createRuleQc24119 = function () {
                return {
                    ...
                    validate: function (viewModel) {
                        ...
                        var gasAmounts08E = viewModel.sheet6.section8.getGasAmounts('tr_08E');
                        var that = this;
            ...
            Sheet1Validator.prototype._createRuleQc2450 = function () {
                return {
                    qccode: 2450,
                    validate: function (viewModel) {
                        var whiteListCompanies = [13089, 13408, 9410, 9411, 9475, 9505, 9506, 9503, 9461, 9558, 9546, 9449, 9763, 9478, 9465, 9428, 14806, 39611, 29215, 9697, 51264, 54215];
