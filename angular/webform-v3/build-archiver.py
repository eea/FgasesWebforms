...
PROD_SCHEMA_URL = 'http://dd.eionet.europa.eu/schemas/fgases-2018/FGasesReporting.xsd'
...
def composeTestSchemaUrl(projectName):
    # fileTemplate = "http://%(webqHost)s/download/project/%(projectName)s/file/FGasesReporting2018.xsd"
    # templateArgs = { 
...
def listTestResources():
    return [
        '../schema/FGasesReporting2018.xsd',
