...
(function() {
    angular.module('FGases.viewmodel').factory('ViewModelSheet4', [
        ...
        function (ViewModelSectionBase, objectUtil, arrayUtil, numericUtil) {
            ...
            ViewModelSheet4Section9.prototype.getTr09A_impSumOfPartnerAmounts = function(tradePartnerId) {
                return numericUtil.toNum(this.getSectionData().tr_09A_imp.SumOfPartnerAmounts);
            };

            ViewModelSheet4Section9.prototype.getTr09A_addSumOfPartnerAmounts = function(tradePartnerId) {
                return numericUtil.toNum(this.getSectionData().tr_09A_add.SumOfPartnerAmounts);
            };
