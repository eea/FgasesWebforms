    ...
    angular.module('FGases.controllers').controller("questionnaire",
        ...
        function($scope, $window, $rootScope, dataRepository, languageChanger, $sce, $location, $filter, $translate,
            ...
            $scope.activityFieldDepedencyMap = {
                ...
                'P': {
                    'clearStatements': [{
                        ...
                        'fields': [
                            { 'form': 'F1_S1_4_ProdImpExp', 'rows': ['tr_01A', 'tr_01A_fs', 'tr_01A_ex', 'tr_01B', 'tr_01C', 'tr_01D', 'tr_01E'] },
                            ...
                            for (var k = 0; k < statement.fields[j].rows.length; k++) {
                                ...
                                for (var l = 0; l < column.length; l++) {
                                    ...
                                    if (angular.isDefined(gasRow.Amount)) {
                                        ...
                                        if (angular.isDefined(gasRow.CountrySpecific.Country)) {
            ...
            $scope.getValueForCountrySpecificReportedGasAmount = function(gasRow) {
                ...
                //if Array
                if (gasRow.CountrySpecific.Country == null) {
                    return 0.0;
                }
                var totalAmount = 0.0;
            ...
            $scope.doCalculationTotalForRow = function(form, gasRow, calculations) {
                ...
                var rowsWithCountrySpecificReporting = ['tr_02A', 'tr_02App', 'tr_02C', 'tr_02D', 'tr_02E','tr_03A','tr_03App','tr_03G','tr_03H','tr_03I'];
            ...
            $scope.form7specificRanges = {
                ...
                'tr_11B12': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 50 },
                'tr_11B13': { 'Outside': false, 'QCCode': '2300', 'lower': 1, 'upper': 50 },
            ...
            $scope.getCommentDataForTr01A_FS = function(gasIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01A_fs;
            };

            $scope.openCommentModalForTr01A_FS = function(gasIndex) {
                var data = $scope.getCommentDataForTr01A_FS(gasIndex);
            ...
            $scope.mandatoryCommentForTr01A_FS = function(gasIndex) {
                var data = $scope.getCommentDataForTr01A_FS(gasIndex);
