        ...
        function($scope, $window, $rootScope, dataRepository, languageChanger, $sce, $location, $filter, $translate,
            ...
            $scope.submitReport = function() {
                if (transactionYearProvider.getTransactionYear() !== transactionYearProvider._maxTransactionYear()) {
                    if (confirm("In this reporting season, reports on " + transactionYearProvider._maxTransactionYear() + " are expected. This report currently refers to 2015 (maybe because you copied an older delivery as a starting point).\n" +
                            "Do you want to set the transaction year to " + transactionYearProvider._maxTransactionYear() + " [OK], or should " + transactionYearProvider.getTransactionYear() + " be kept as the transaction year [Cancel]?")) {
                        ...
                        alert('Transaction year has been set to ' + transactionYearProvider._maxTransactionYear() + '. Registry and stock data for 2016 are loaded. Please review sections 4 and 9 of the report.');
                        return;
                    }
                }
