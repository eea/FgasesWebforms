    ...
    angular.module('FGases.controllers').controller("questionnaire",
        ...
        function($scope, $window, $rootScope, dataRepository, languageChanger, $sce, $location, $filter, $translate,
            ...
            $scope.initFormulas = function() {
                                                 ...
                                                 var v_tr_05G_formula = ($scope.instance.FGasesReporting.GeneralReportData.TransactionYear > FormConstants.PivotYear) ? v_tr_05G_formula_2018 : v_tr_05G_formula_2017;
                                                 $scope.formulasForRows = {
                                                     ...
                                                     'tr_05G': { 'formula': v_tr_05G_formula, 'dependents': 'tr_05I' },
            ...
            $scope.printPreview = function() {
                ...
                dataRepository.saveInstanceXml($scope.instance).success(function() {
                    var result = confirm("Print Preview will open in a new Window.");
                    if (result) {
            ...
            $scope.getCommentDataForTr01A_FS = function(gasIndex) {
                return $scope.instance.FGasesReporting.F1_S1_4_ProdImpExp.Gas[gasIndex].tr_01A;
            };
