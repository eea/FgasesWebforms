...
(function() {
    angular.module('FGases.viewmodel').factory('ViewModelSheet8', [
        ...
        function (ViewModelSectionBase, objectUtil, gasHelper, arrayUtil) {
            ...
            ViewModelSheet8Section12.prototype.getGasIndex = function(gas_id) {
                var r_gases = this.getRoot().getDataSource().FGasesReporting.ReportedGases;
                for (var i=0; i < r_gases.length; i++) {
                    if (gas_id == r_gases[i].GasId) {
                        return i;
                    }
                }
            };
