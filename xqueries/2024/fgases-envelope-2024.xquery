...
(:~
 ...
 : XML Schema:  : XML Schema: http://dd.eionet.europa.eu/schemas/fgases-2024/FGasesReporting.xsd
 :
...
declare variable $SCHEMA as xs:string := "http://dd.eionet.europa.eu/schemas/fgases-2024/FGasesReporting.xsd";
