...
(:~
 ...
 : XML Schema:  : XML Schema: http://dd.eionet.europa.eu/schemas/fgases-2025/FGasesReporting.xsd
 :
...
declare variable $SCHEMA as xs:string := "http://dd.eionet.europa.eu/schemas/fgases-2025/FGasesReporting.xsd";
