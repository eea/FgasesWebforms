...
import module namespace cutil = "http://converters.eionet.europa.eu/fgases/cutil" at "fgases-common-util-2025-verification.xquery";
(: UI utility methods for build HTML formatted QA result:)
import module namespace uiutil = "http://converters.eionet.europa.eu/fgases/ui" at "fgases-ui-util-2025-verification.xquery";
...
as element(div)*
{
    ...
    if (exists($report/Transactions[id="tr_11P"])) then
        for $name in ("tr_11G","11_J1", "tr_12A", "tr_12aA","tr_12B","tr_12aB", "tr_13D","tr_11P")
             return $report/EquipmentHFCs/section_II_2/*[name() = $name]            
    else for $name in ("tr_11G","11_J1", "tr_12A", "tr_12aA","tr_12B","tr_12aB", "tr_13D")       
            return $report/EquipmentHFCs/section_II_2/*[name() = $name]  
...
as element(div)*
{
    ...
    let $pathII2 := ($report/EquipmentHFCs/section_II_2/tr_11G,$report/EquipmentHFCs/section_II_2/tr_11_J1, $report/EquipmentHFCs/section_II_2/tr_12A, $report/EquipmentHFCs/section_II_2/tr_12aA, $report/EquipmentHFCs/section_II_2/tr_12B, $report/EquipmentHFCs/section_II_2/tr_12aB, $report/EquipmentHFCs/section_II_2/tr_13D, $report/EquipmentHFCs/section_II_2/tr_11P )
...
as element(div)*
{
    ...
    let $pathII2 :=($report/EquipmentHFCs/section_II_2/tr_11G,$report/EquipmentHFCs/section_II_2/tr_11_J1, $report/EquipmentHFCs/section_II_2/tr_12A, $report/EquipmentHFCs/section_II_2/tr_12aA, $report/EquipmentHFCs/section_II_2/tr_12B, $report/EquipmentHFCs/section_II_2/tr_12aB, $report/EquipmentHFCs/section_II_2/tr_13D, $report/EquipmentHFCs/section_II_2/tr_11P )
     (:$report/EquipmentHFCs/section_II_2/tr_11G, $report/EquipmentHFCs/section_II_2/tr_12A, $report/EquipmentHFCs/section_II_2/tr_12aA, $report/EquipmentHFCs/section_II_2/tr_13D, $report/EquipmentHFCs/section_II_2/tr_11P ):)
...
as element(div)*
{
    ...
    let $pathI1 := ($report/BulkHFCs/section_I_1)
    let $pathI2 := ($report/BulkHFCs/section_I_2/tr_01A, $report/BulkHFCs/section_I_2/tr_01A_a_own, $report/BulkHFCs/section_I_2/tr_01A_a_other, $report/BulkHFCs/section_I_2/tr_01B, $report/BulkHFCs/section_I_2/tr_01C, $report/BulkHFCs/section_I_2/tr_02A, $report/BulkHFCs/section_I_2/tr_02B, $report/BulkHFCs/section_I_2/tr_02G, $report/BulkHFCs/section_I_2/tr_02H, $report/BulkHFCs/section_I_2/tr_02I,$report/BulkHFCs/section_I_2/tr_03B, $report/BulkHFCs/section_I_2/tr_04C, $report/BulkHFCs/section_I_2/tr_04H, $report/BulkHFCs/section_I_2/tr_05A, $report/BulkHFCs/section_I_2/tr_05B, $report/BulkHFCs/section_I_2/tr_05C_exempted, $report/BulkHFCs/section_I_2/tr_05D, $report/BulkHFCs/section_I_2/tr_05E, $report/BulkHFCs/section_I_2/tr_09A, $report/BulkHFCs/section_I_2/tr_09C )
...
as element(div)*
{
    ...
    let $pathII3 := $report/EquipmentHFCs/section_II_3
    let $pathII4 := $report/EquipmentHFCs/section_II_4
    let $errorText := 'It is not plausible that you choose option (2) for the Declaration of Conformity when HFCs >0 are reported for 13D, options a) or b) were selected for the veracity statement on 13D and you confirmed the documentation of compliance in section II-3.'

    return if (xmlconv:getDouble($checkpath/tco2e) > 0 and ($pathII2/confirmation_a/checked = "true" or $pathII2/confirmation_b/checked = "true" ) and ($pathII3/confirmation_a/checked = "true" or $pathII3/confirmation_b/checked = "true") and ($pathII4/option_a/option = "2" )) then (:or $pathII4/option_a/option = "3":)
...
as element(div)*
{
    ...
    return 
    if ($pathII4/option_b/option = "3" and string-length($pathII4/option_b/reason_3) = 0)then (
 
        if ((xmlconv:getDouble($checkpath/tco2e) > 0 ) and ($pathII2/confirmation_a/checked = "true" or $pathII2/confirmation_b/checked = "true" )) then
        uiutil:buildRuleResult("3024", "", $errorText, $xmlconv:BLOCKER, true(), (), "")
        else(),

        if ((xmlconv:getDouble($checkpath2/tco2e) > 0 ) and ($pathII3/confirmation_a/checked = "true" or $pathII3/confirmation_b/checked = "true" ) ) then
        uiutil:buildRuleResult("3024", "", $errorText, $xmlconv:BLOCKER, true(), (), "")
        else()
        )
    else()
...
as element(div)*
{
    ...
    let $pathII2 := $report/EquipmentHFCs/section_II_2/tr_12A
    let $checkpath2 := $report/ReportedEquipment/Transactions[id = 'tr_12B']
    let $pathII2B := $report/EquipmentHFCs/section_II_2/tr_12B
    let $pathII3 := $report/EquipmentHFCs/section_II_3
    let $pathII4 := $report/EquipmentHFCs/section_II_4
    let $errorText := 'It is not plausible that you choose option (2) or (3) for the Declaration of Conformity (Part 2 of section II-4) when HFCs >0 are reported and confirmed for 12A or 12B (Table 2 in section II-2) and option a) or b) was selected for the summary verification statement (section II-3). Please reconsider the selected statements.'

    return if ((xmlconv:getDouble($checkpath/tco2e) > 0 and ($pathII2/confirmation_a/checked = "true" or $pathII2/confirmation_b/checked = "true" ) and ($pathII3/confirmation_a/checked = "true" or $pathII3/confirmation_b/checked = "true") and ($pathII4/option_b/option = "2" or $pathII4/option_b/option = "3")) 
        or     (xmlconv:getDouble($checkpath2/tco2e) > 0 and ($pathII2B/confirmation_a/checked = "true" or $pathII2B/confirmation_b/checked = "true" ) and ($pathII3/confirmation_a/checked = "true" or $pathII3/confirmation_b/checked = "true") and ($pathII4/option_b/option = "2" or $pathII4/option_b/option = "3")))then
        uiutil:buildRuleResult("3025", "", $errorText, $xmlconv:BLOCKER, true(), (), "")
    else()
};

declare function xmlconv:qc3030($report as element())
as element(div)*
{
...
declare function xmlconv:qc3031($report as element())
as element(div)*
{
    let $checkpath := $report/ReportedEquipment/Transactions[id = 'tr_12aA']
...
declare function xmlconv:qc3032($report as element())
as element(div)*
{
    let $checkpath := $report/ReportedEquipment/Transactions[id = 'tr_12aA']
    let $checkpath2 := $report/ReportedEquipment/Transactions[id = 'tr_12aB']
    ...
    return 
    if ($pathII4/option_c/option = "3" and string-length($pathII4/option_c/reason_3) = 0)then(
        if ((xmlconv:getDouble($checkpath/tco2e) > 0 ) and ($pathII2/confirmation_a/checked = "true" or $pathII2/confirmation_b/checked = "true"))  then
            uiutil:buildRuleResult("3032", "", $errorText, $xmlconv:BLOCKER, true(), (), "")
        else(),
        if ((xmlconv:getDouble($checkpath2/tco2e) > 0 ) and ($pathII3/confirmation_a/checked = "true" or $pathII3/confirmation_b/checked = "true") ) then
            uiutil:buildRuleResult("3032", "", $errorText, $xmlconv:BLOCKER, true(), (), "")
        else()
...
(:declare function xmlconv:qc3033($report as element())
as element(div)*
{
    let $tr_12aA := $report/ReportedEquipment/Transactions[id = 'tr_12aA']
    let $tr_12aB := $report/ReportedEquipment/Transactions[id = 'tr_12aB']
    let $tr_12aA_confirmation := $report/EquipmentHFCs/section_II_2/tr_12aA
    let $tr_12aB_confirmation := $report/EquipmentHFCs/section_II_2/tr_12aB
    let $sectionII3 := $report/EquipmentHFCs/section_II_3
    let $sectionII4 := $report/EquipmentHFCs/section_II_4
    let $errorText := "The auditor's selection 'No'/'Option C was no used...' in section II-4, Part 3: option C of DoCs is not plausible as HFC amounts > 0 have been reported by the undertaking in 12aA/12aB and have been confirmed in section II-2 by the auditor. Please reconsider the combination of these verification statements."

    return 
    if ($sectionII4/option_c/option = "3" or $sectionII4/option_c/option = "2") then 
        
        if (($sectionII3/confirmation_a/checked = "true" or $sectionII3/confirmation_b/checked = "true")) then(            

            if (xmlconv:getDouble($tr_12aA/tco2e) > 0 and ($tr_12aA_confirmation/confirmation_a/checked = "true" or $tr_12aA_confirmation/confirmation_b/checked = "true"))

            then uiutil:buildRuleResult("3033", "", $errorText, $xmlconv:BLOCKER, true(), (), "")
            else (),            
            
            if (xmlconv:getDouble($tr_12aB/tco2e) > 0 and ($tr_12aB_confirmation/confirmation_a/checked = "true" or $tr_12aB_confirmation/confirmation_b/checked = "true"))
            then uiutil:buildRuleResult("3033", "", $errorText, $xmlconv:BLOCKER, true(), (), "")
            else()
        )
        else ()         
...
as element(div)*
{
    if ($report/VerificationScope/Equipment="true") then
        ...
        let $pathII4_c := $report/EquipmentHFCs/section_II_4/option_c
        let $errorTextII4_c := 'One of the boxes in section II-4, Part 3 must be selected.'
        ...
        let $errorsII4_c :=
        if ($pathII4_c/option = "1" or $pathII4_c/option = "2" or $pathII4_c/option = "3")
            then
                ()
            else
                uiutil:buildRuleResult("3017", "", $errorTextII4_c, $xmlconv:BLOCKER, true(), (), "")

        return
            ($errorsII4_a, $errorsII4_b, $errorsII4_c)
    else ()
