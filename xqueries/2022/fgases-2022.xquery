...
(:
 ...
 :
 : Version:     $Id: fgases-2021.xquery 22084 2021-03-10 13:31:33Z katsanas $
 : Created:     20 November 2014
 : Copyright:   European Environment Agency
 :)
(:~
 : Reporting Obligation: http://rod.eionet.europa.eu/obligations/713
 : XML Schema: http://dd.eionet.europa.eu/schemas/fgases-2021/FGasesReporting.xsd
 :
...
import module namespace cutil = "http://converters.eionet.europa.eu/fgases/cutil" at "fgases-common-util-2022.xquery";
(: UI utility methods for build HTML formatted QA result:)
import module namespace uiutil = "http://converters.eionet.europa.eu/fgases/ui" at "fgases-ui-util-2022.xquery";
import module namespace fgases = 'http://converters.eionet.europa.eu/fgases/helper' at "fgases-helper-2022.xquery";
...
{  
    ...
    for $blendComponent in $gases/BlendComponents
        ...
        let $totalPercentage:= sum($components/Percentage)
        where
...
as element(div)
{
    ...
    let $resultDiv :=
        ...
        then
            ...
            let $r2301_11A6 := xmlconv:validateTransactionAmountRange($doc, "11A06", 0.8, 50.0, "kg/piece", "2300")
            ...
            let $r2301_11A12 := xmlconv:validateTransactionAmountRange($doc, "11A12", 0.05, 50.0, "kg/piece", "2300")
            let $r2301_11A13 := xmlconv:validateTransactionAmountRange($doc, "11A13", 0.05, 50.0, "kg/piece", "2300")
            ...
            let $r2301_11B8 := xmlconv:validateTransactionAmountRange($doc, "11B08", 0.75, 50.0, "kg/piece", "2300")
            ...
            let $r2301_11B13 := xmlconv:validateTransactionAmountRange($doc, "11B13", 0.1, 50.0, "kg/piece", "2300")
            ...
            let $r2301_11E2 := xmlconv:validateTransactionAmountRange($doc, "11E02", 0.05, 1.6, "kg/piece", "2300")
            ...
            let $r2301_11F4 := xmlconv:validateTransactionAmountRange($doc, "11F04", 0.03, 1.5, "kg/piece", "2300")
