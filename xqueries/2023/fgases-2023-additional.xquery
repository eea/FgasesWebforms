...
(:
 ...
 :
 : Version:     $Id: fgases-2023.xquery 20266 2016-01-27 09:18:28Z zykaerv $
...
(: QC-2404 :)
    ...
    let $tr09AImp := cutil:if-number($doc/F4_S9_IssuedAuthQuata/tr_09A_imp/SumOfPartnerAmounts,0)
    ...
    return
        if($tr09AImp > 0) then
            if( $isAuth  ) then
                ...
                uiutil:buildRuleResult("2404", "09A_imp", $errorText, $xmlconv:COMPLIANCE, true(), (), "")
        else
            ()
};
