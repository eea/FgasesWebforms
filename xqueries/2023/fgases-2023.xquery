...
(:
 ...
 :
 : Version:     $Id: fgases-2023.xquery 22084 2023-03-10 13:31:33Z katsanas $
 : Created:     20 November 2014
 : Copyright:   European Environment Agency
 :)
(:~
 : Reporting Obligation: http://rod.eionet.europa.eu/obligations/713
 : XML Schema: http://dd.eionet.europa.eu/schemas/fgases-2023/FGasesReporting.xsd
 :
...
import module namespace cutil = "http://converters.eionet.europa.eu/fgases/cutil" at "fgases-common-util-2023.xquery";
(: UI utility methods for build HTML formatted QA result:)
import module namespace uiutil = "http://converters.eionet.europa.eu/fgases/ui" at "fgases-ui-util-2023.xquery";
import module namespace fgases = 'http://converters.eionet.europa.eu/fgases/helper' at "fgases-helper-2023.xquery";
...
as element(div)*
{
    ...
    for $gas in $report/F1_S1_4_ProdImpExp/Gas
        ...
        let $tr08EAmount := cutil:numberIfEmpty($report/F6_FUDest/Gas[GasCode=$gasCode]/tr_08E/Amount, 0)
        where
...
declare function xmlconv:qc2456($reportedData as element(FGasesReporting), $gases as element(Gas)*)
as element(div)*
{
    let $invalidGasTransactions :=
        for $gas in $gases
        let $transactionData := $gas/*[fn:local-name()="tr_08C"]
        where not(cutil:transactionHasMandatoryComment($transactionData))
        return    
            let $gasName := cutil:getGasNameByGasCode($reportedData, $gas/GasCode)
            let $errorText := xmlconv:getQC2456ErrorMessage($gasName, "tr_08C")
            return uiutil:buildRuleResult("2456", "tr_08C", $errorText, $xmlconv:BLOCKER, true(), (), "")
    return $invalidGasTransactions
};
...
as element(div)
{
    ...
    let $resultDiv :=
        ...
        then
            ...
            let $r2301_11A2 := xmlconv:validateTransactionAmountRange($doc, "11A02", 0.4, 50.0, "kg/piece", "2300")
            let $r2301_11A3 := xmlconv:validateTransactionAmountRange($doc, "11A03", 0.1, 50.0, "kg/piece", "2300")
            let $r2301_11A4 := xmlconv:validateTransactionAmountRange($doc, "11A04", 0.5, 50.0, "kg/piece", "2300")
            let $r2301_11A5 := xmlconv:validateTransactionAmountRange($doc, "11A05", 0.05, 3.0, "kg/piece", "2300")
            let $r2301_11A6 := xmlconv:validateTransactionAmountRange($doc, "11A06", 0.5, 50.0, "kg/piece", "2300")
            ...
            let $r2301_11A10 := xmlconv:validateTransactionAmountRange($doc, "11A10", 0.4, 10.0, "kg/piece", "2300")
            ...
            let $r2301_11B1 := xmlconv:validateTransactionAmountRange($doc, "11B01", 0.03, 2.0, "kg/piece", "2300")
            let $r2301_11B2 := xmlconv:validateTransactionAmountRange($doc, "11B02", 0.03, 50.0, "kg/piece", "2300")
            ...
            let $r2301_11B8 := xmlconv:validateTransactionAmountRange($doc, "11B08", 0.6, 50.0, "kg/piece", "2300")
            let $r2301_11B9 := xmlconv:validateTransactionAmountRange($doc, "11B09", 1, 50.0, "kg/piece", "2300")
            let $r2301_11B10 := xmlconv:validateTransactionAmountRange($doc, "11B10", 0.2, 50.0, "kg/piece", "2300")
            let $r2301_11B11 := xmlconv:validateTransactionAmountRange($doc, "11B11", 1, 50.0, "kg/piece", "2300")
            let $r2301_11B12 := xmlconv:validateTransactionAmountRange($doc, "11B12", 0.03, 50.0, "kg/piece", "2300")
            let $r2301_11B13 := xmlconv:validateTransactionAmountRange($doc, "11B13", 0.05, 50.0, "kg/piece", "2300")
            let $r2301_11B14 := xmlconv:validateTransactionAmountRange($doc, "11B14", 1, 50.0, "kg/piece", "2300")
            let $r2301_11C := xmlconv:validateTransactionAmountRange($doc, "11C", 0.15, 0.75, "kg/piece", "2300")
            let $r2301_11D1 := xmlconv:validateTransactionAmountRange($doc, "11D01", 0.03, 50.0, "kg/piece", "2300")
            ...
            let $r2301_11E1 := xmlconv:validateTransactionAmountRange($doc, "11E01", 0.1, 13.0, "kg/piece", "2300")
            let $r2301_11E2 := xmlconv:validateTransactionAmountRange($doc, "11E02", 0.025, 1.6, "kg/piece", "2300")
            let $r2301_11E3 := xmlconv:validateTransactionAmountRange($doc, "11E03", 10.0, 50.0, "kg/piece", "2300")
            let $r2301_11E4 := xmlconv:validateTransactionAmountRange($doc, "11E04", 0.03, 5.0, "kg/piece", "2300")
            ...
            let $r2301_11F3 := xmlconv:validateTransactionAmountRange($doc, "11F03", 0.2, 1.5, "kg/piece", "2300")
            let $r2301_11F4 := xmlconv:validateTransactionAmountRange($doc, "11F04", 0.03, 2, "kg/piece", "2300")
            ...
            let $r2301_11F8 := xmlconv:validateTransactionAmountRange($doc, "11F08", 2.0, 20.0, "kg/piece", "2300")
            ...
            let $r2301_11H4 :=
                if($doc/F7_s11EquImportTable/TR_11H4_Unit="metrictonnes") then
                    ...
                    xmlconv:validateTransactionAmountRange($doc, "11H04", 1.0, 10.0, "kg/m3", "2300")
                        ...
                        ()
            let $r2301_11I := xmlconv:validateTransactionAmountRange($doc, "11I", 0.1, 50.0, "kg/piece", "2300")
            ...
            let $r2456 := xmlconv:qc2456($doc, $doc/F1_S1_4_ProdImpExp/Gas)
