...
import module namespace cutil = "http://converters.eionet.europa.eu/fgases/cutil" at "fgases-common-util-2018.xquery";
(: UI utility methods for build HTML formatted QA result:)
import module namespace uiutil = "http://converters.eionet.europa.eu/fgases/ui" at "fgases-ui-util-2018.xquery";
import module namespace fgases = 'http://converters.eionet.europa.eu/fgases/helper' at "fgases-helper-2018.xquery";
        ...
        if (not($isD)) then
            ...
            return
                ...
                return
                    ...
                    let $gasAmount1A_a_ownComment := $doc/F1_S1_4_ProdImpExp/Gas[GasCode = $gasCode]/tr_01A_a_own
                    let $errorType :=
